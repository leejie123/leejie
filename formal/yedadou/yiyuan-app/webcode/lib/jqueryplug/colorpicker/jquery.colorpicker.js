    ...
    $.fn.colorpicker = function(options) {
        ...
        return this.each(function(){
            ...
            obj.bind(opts.event,function(){
                ...
                $([document.body,window]).on('mousedown.colorpicker',function arguments_callee6() {
                    console.log('mousedown.colorpicker');
                     $("#colorpanel").hide();
                    $([document.body,window]).off('mousedown.colorpicker',arguments_callee6);
                });
        ...
        function initColor(){
            ...
            colorTable='<table width=253 border="0" cellspacing="0" cellpadding="0" style="border:1px solid #000;font-size: 12px;padding-left: 20px;">'
