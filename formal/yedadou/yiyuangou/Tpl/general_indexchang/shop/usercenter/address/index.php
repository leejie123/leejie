		...
		<div class="wrapper">
			...
			<div class="cart-container">
				<form id="dataForm" method="post" action="<?=$addressUrl?>" >
							...
							<div class="container-fluid">
								<div class="row">
									...
									<div class="label-content-wrapper">
									    <a title="删除地址" class="pull-right edit-address" href="/shop/UserCenter/address/delete?id=<?=$v['id']?>" style="position: relative;left: 10px;">
					...
					<?php else:?>
					<!--收货地址为空-->
					<div class="cart-empty text-center hide">
