...
<form id="payGo" method="post">
	...
	<div class="padContent paySet clearfix" style="height: 40px;">
		<div class="group">
		<div class="checkbox" id="agreeDiv">
		  	...
		  	<label style="top:2px;"></label>
  		</div>
		<span style="margin-left: 55px;"> 我已阅读并同意《<a href="#" id="agreeContent" style="color:#f60;">一元购商城购物条款</a>》</span>
		</div>
	</div>
