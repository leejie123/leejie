...
<title>商品详情</title>
<link href="{__STATIC_URL__}/public/yiyuan/css/productDetails.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<script>
	$(function(){
		...
		$('.shareBtn').click(function(){
			var strDiv=$('<div><img src="{__STATIC_URL__}/public/yiyuan/images/sharetip.png" alt="点击右上角【发送给朋友】或【分享到朋友圈】" width="90%"></div>');
