...
<h3>订单    }<span style=" color: red;">是否工人购买:  1是   0否 |</span><span style=" color: red;">是否中奖:  1是   0否 </span></h3>
<?php if(!empty($order)):?>
<ol>
	<?php foreach($order as $v):?>
	<li>商品id：<?php echo $v['goods_id'];?>&nbsp;&nbsp;期数： <?php echo $v['term'];?>&nbsp;&nbsp;购买者id:<?=$v['buyer_id']?>&nbsp;&nbsp;购买者名字:<?=$v['buyer_nick']?>&nbsp;&nbsp;是否中奖:<?=$v['hit']?>&nbsp;&nbsp;期数id:<?=$v['term_id']?>&nbsp;&nbsp;是否工人购买:<?=$v['is_robot_buy']?>&nbsp;&nbsp;订单号：<?=$v['order_sn']?>&nbsp;&nbsp;幸运号:<?=$v['code']?>&nbsp;&nbsp;时间:<?=date("Y-m-d H:i:s", $v['add_time'])?></li>
	<?php endforeach;?>
</ol>
<?php endif;?>
...
<h3>期数,商品    |<span style=" color: red;">是否工人中奖:  1是   0否 </span></h3>
<?php if(!empty($term_data)):?>
<ul>
	<?php foreach($term_data as $v):?>
	<li>期数id：<?php echo $v['id']; ?>&nbsp;&nbsp;商品id：<?php echo $v['goods_id']; ?>&nbsp;&nbsp;期数： <?php echo $v['term'];?> &nbsp;&nbsp;总幸运码：<?=$v['code_num']?>&nbsp;&nbsp;已购买幸运码：<?=$v['buy_num']?>&nbsp;&nbsp;是否工人中奖：<?=$v['is_robot_winning']?>&nbsp;&nbsp;中奖用户id:<?=$v['hit_uid']?>&nbsp;&nbsp;中奖幸运码:<?=$v['hit_code']?></li>
	<?php endforeach;?>
</ul>
...
<ul>
	...
	<li>工人用户id：<?php echo $v['uid'];?>&nbsp;&nbsp;&nbsp;&nbsp;工人名称： <?php echo $v['nick'];?>&nbsp;&nbsp;&nbsp;&nbsp;工人地区：<?php echo $v['area'];?></li>
	<?php endforeach;?>
</ul>
<?php endif;?>
<?php endif;?>
