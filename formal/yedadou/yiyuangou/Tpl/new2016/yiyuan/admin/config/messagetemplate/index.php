					...
					<div class="tabbable">
						...
						<div class="tab-content no-border padding-0 pt10">
							<div id="tab1" class="tab-pane active">
								<form class="form-horizontal" method="post" action=""  id="msg_tpl_form" data-submit="auto">
									<div class="row">
										<div class="col-xs-6">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<textarea id="paySuccessSuper" name="paySuccessSuper" maxlength="300"  class="form-control height80" placeholder="请输入要回复的内容"><?php echo isset($msgTpl['paySuccessSuper'])  ? $msgTpl['paySuccessSuper']:'';?></textarea>
																	<!--<span class="input-group-addon" style="cursor:pointer">使用微信模板</span>-->
																</div>
															</div>
														</td>
													...
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<textarea id="ship" name="ship" maxlength="300"  class="form-control height80" placeholder="请输入要回复的内容"><?php echo isset($msgTpl['ship'])  ? $msgTpl['ship']:'';?></textarea>
																	<!--<span class="input-group-addon" style="cursor:pointer">使用微信模板</span>-->
																</div>
															</div>
														</td>
													...
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<textarea id="winning" name="winning" maxlength="300"  class="form-control height80" placeholder="请输入要回复的内容"><?php echo isset($msgTpl['winning'])  ? $msgTpl['winning']:'';?></textarea>
																	<!--<span class="input-group-addon" style="cursor:pointer">使用微信模板</span>-->
																</div>
															</div>
														</td>
													...
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<textarea id="winning_sms" name="winning_sms" maxlength="300"  class="form-control height80" placeholder="请输入要回复的内容"><?php echo isset($msgTpl['winning_sms'])  ? $msgTpl['winning_sms']:'';?></textarea>
																</div>
															</div>
														</td>
													</tr>
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<textarea id="pintuan_buildSuccess" name="pintuan_buildSuccess" maxlength="300"  class="form-control height80" placeholder="请输入要回复的内容"><?php echo isset($msgTpl['pintuan_buildSuccess'])  ? $msgTpl['pintuan_buildSuccess']:'';?></textarea>
																</div>
															</div>
														</td>
													</tr>
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<textarea id="pintuan_joinSuccess" name="pintuan_joinSuccess" maxlength="300"  class="form-control height80" placeholder="请输入要回复的内容"><?php echo isset($msgTpl['pintuan_joinSuccess'])  ? $msgTpl['pintuan_joinSuccess']:'';?></textarea>
																</div>
															</div>
														</td>
													</tr>
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<textarea id="pintuan_lotterySuccess" name="pintuan_lotterySuccess" maxlength="300"  class="form-control height80" placeholder="请输入要回复的内容"><?php echo isset($msgTpl['pintuan_lotterySuccess'])  ? $msgTpl['pintuan_lotterySuccess']:'';?></textarea>
																</div>
															</div>
														</td>
													</tr>
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<textarea id="pintuan_commissionSuccess_master" name="pintuan_commissionSuccess_master" maxlength="300"  class="form-control height80" placeholder="请输入要回复的内容"><?php echo isset($msgTpl['pintuan_commissionSuccess_master'])  ? $msgTpl['pintuan_commissionSuccess_master']:'';?></textarea>
																</div>
															</div>
														</td>
													</tr>
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<textarea id="pintuan_fail" name="pintuan_fail" maxlength="300"  class="form-control height80" placeholder="请输入要回复的内容"><?php echo isset($msgTpl['pintuan_fail'])  ? $msgTpl['pintuan_fail']:'';?></textarea>
																</div>
															</div>
														</td>
													</tr>
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<textarea id="refundSuccess" name="refundSuccess" maxlength="300"  class="form-control height80" placeholder="请输入要回复的内容"><?php echo isset($msgTpl['refundSuccess'])  ? $msgTpl['refundSuccess']:'';?></textarea>
																</div>
															</div>
														</td>
													</tr>
