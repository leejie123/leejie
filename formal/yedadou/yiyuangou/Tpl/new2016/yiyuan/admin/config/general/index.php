					...
					<div class="tabbable">
						...
						<div class="tab-content no-border padding-0 pt10">
							<div id="tab1" class="tab-pane active">
								<form class="form-horizontal" method="post" action=""    data-submit="auto">
									<table id="" class="table table-bordered">
										<tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group no-margin-left no-margin-right mt4 short">
                                                        <input type="text" id="MainProducts1" name="MainProducts1" class="form-control" value="<?php echo val($ganeral, 'MainProducts1','');?>" placeholder="请输入商品ID" />
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group no-margin-left no-margin-right mt4 short">
                                                        <input type="text" id="MainProducts2" name="MainProducts2" class="form-control" value="<?php echo val($ganeral, 'MainProducts2','');?>" placeholder="请输入商品ID" />
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group no-margin-left no-margin-right mt4 short">
                                                        <textarea style="height: 90px;" id="service" name="service" class="form-control" placeholder="请将客服插件代码按原格式粘贴到此输入框内"><?php echo val($ganeral, 'service','');?></textarea>
                                                    </div>
                                                    <!--                                                    <div class="form-group no-margin-left no-margin-right mt4 short">-->
                                                    <!--                                                        <input type="text" id="service" name="service" class="form-control" value="--><?php //echo val($ganeral, 'MainProducts1','');?><!--" placeholder="请输入客服插件代码" />-->
                                                    <!--                                                    </div>-->
                                                </td>
                                            </tr>
