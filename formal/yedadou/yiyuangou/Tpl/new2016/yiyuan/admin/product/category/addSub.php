...
<html>
	...
	<body class="no-skin">
		<link rel="stylesheet" href="{__STATIC_URL__}/public??/admin/css/shop/product/category/addSub.css" />
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form method="post" action=""  data-submit="auto">
						<!--分类ID-->
						<input type="hidden" name="parent_cid" id="parent_cid" value="<?php echo $parent_cid ?>" />
						<div class="form-group">
							<div class="label-wrapper">
								<label class="" for="name"><strong>分类名称：</strong></label>
							</div>
							<div class="control-wrapper short">
								<input id="name" name="name" type="text" class="form-control" value="" placeholder="" />
							</div>
						</div>
						<div class="form-group">
							<div class="label-wrapper">
							...
							<div class="control-wrapper short">
								<input id="order" name="sort_order" type="text" class="form-control" value="<?php echo isset($sort_order)?$sort_order:1;?>" placeholder="" />
							</div>
						</div>
						<div class="form-group">
							<div class="label-wrapper">
							...
							<div class="control-wrapper short">
								<label class="pos-rel">
									<input id="isShow" name="display" type="checkbox" class="ace" checked/>
									<span class="lbl"></span>
								</label>
							</div>
						</div>
						<div class="form-group">
							<div class="label-wrapper">
								<label class="" for=""><strong>分类图片：</strong><br><span style="color:#f00">注：图片尺寸57x57</span></label>
							</div>
							<div class="control-wrapper short">
								<div class="input-group">
									<input type="text" value="" id="imageUrl" name="pic_url" class="form-control" placeholder="请直接输入图片地址或使用上传图片按钮上传图片"/>
						...
						<div class="button-panel">
							<button type="submit" class="btn btn-info btn-sm btn-space-right" data-href="/yiyuan/admin/product/category/add" data-action="submit" data-refresh="parent" data-mask="parent"><i class='ace-icon fa fa-check'></i> 确定</button>
		...
		<script src="{__STATIC_URL__}/public/admin/js/shop/product/category/addSub.js"></script>
	</body>
