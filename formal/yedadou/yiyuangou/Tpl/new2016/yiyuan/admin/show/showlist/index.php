				...
				<div class="col-xs-12">
					...
					<div class="tabbable">
						<ul class="nav nav-tabs padding-12 tab-color-blue">
							<li class="active">
								<a data-toggle="tab" href="#tab1">晒单管理</a>
							</li>
						</ul>
						...
						<div class="tab-content no-border padding-0 pt10">
							<div id="tab1" class="tab-pane active">
								...
								<div class="table-head-toolbar clearfix">
									<form method="get" action="/yiyuan/admin/show/showList/get">
									...
									<!-- <a class="btn btn-success btn-sm" id="id-add" href="">删除</a> -->
								</div>
								...
								<table id="dynamic-table" class="table table-striped table-bordered table-hover table-vertical-middle">
									<thead>
										<tr>
											...
											<th class="center">晒单会员</th>
											<th class="center">会员ID</th>
											<th class="center">晒单标题</th>
											<th class="center">晒单内容</th>
											<th class="center">晒单时间</th>
									...
									<tbody>
										...
										<tr id="row-<?php echo $key; ?>" data-id="<?php echo isset($value['id'])?$value['id']:''; ?>">
											...
											<td class="center"><?=$value['comment']?></td>
											<td class="center">
												<a href="/yiyuan/admin/show/showList/add?id=<?php echo isset($value['id'])?$value['id']:''; ?>" class="blue" >回复</a>
												<a href="#" data-url="/yiyuan/admin/show/showList/delete?id=<?php echo isset($value['id'])?$value['id']:''; ?>" class="blue" data-id="delete">删除</a>
											</td>
										</tr>
										<?php endforeach;?>
										<?php }?>
