<footer>
	<nav>
		...
		<a href="/yiyuan/ShopGoods/ProductInterval"><i class="yiyuan-icon icon-th-large-outline">&#xe803;</i>最新揭晓</a>
		...
		<a href="/yiyuan/UserCenter/"><i class="yiyuan-icon icon-user">&#xe806;</i>我</a>
	</nav>
</footer>