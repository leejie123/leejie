                                        ...
                                        <div class="tab-content padding-0 pt10">
                                            <div id="t1" class="tab-pane active clearfix">
                                                ...
                                                <div class="form-group clearfix">
                                                    ...
                                                    <div class="control-wrapper short">
                                                        <div class="input-group ">
                                                            <input type="text" value="1.00" name="commission" id="commission" class="form-control" placeholder="">
                                                            <span class="input-group-addon">元</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group clearfix">
                                                    ...
                                                    <div class="control-wrapper short">
                                                        <div class="input-group ">
                                                            <input type="text" value="1" name="stock" id="stock" class="form-control" placeholder="">
