        ...
        <div class="title" onclick="window.location.href='/yiyuan/pintuan/group?tid=<?php echo val($val, 'id'); ?>';">
           ...
           <div class="right clearfix" style="position:relative;">
                <div>
                 ...
                 <div class="">
                    <div class="price">价值：¥<span class=""><?php echo val($val, 'goods_price'); ?></span></div>
                    <div class="count">已参与：<span class="red"><?php echo val($val, 'join_num'), '/', val($val, 'player_num'); ?></span></div>
                 </div>
                 <?php
                    switch ($val['status']) {
                        case 0:
