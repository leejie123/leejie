...
<link href="{__STATIC_URL__}/public/yiyuan/new2016/css/index.css?v=2016331" rel="stylesheet" type="text/css" />
<style>
	body {
		width: 100%!important;
	}
		...
		?>
			<div>
				<a href="<?=$value['link']?>" target="_blank">
					<img src="<?php echo val($value,'pic_url','');?>" style="height:200px;">
				</a>
		    </div>
		<?php endforeach;?>
		<?php }?>
