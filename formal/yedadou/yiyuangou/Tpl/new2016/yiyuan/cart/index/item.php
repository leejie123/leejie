...
<div class="item clearfix" data-goodsid="<?=$v['goods_id'];?>" data-id="<?=$v['id'];?>" data-termid='<?=$v['term_id'];?>' id="cart-<?=$v['id'];?>">
	...
	<div class="info clearfix" style="position: relative;top: 18px;margin-left: 125px;">
		...
		<div class="other">
			...
			<div class="left">
				<div class="tip">
					第（<span class="red1"><?=$v['term'];?></span>）期
					<?php if($v['status'] ==1):?>剩余 <span class="" id="surplusNum-<?=$v['id'];?>"><?=$v['code_num'];?></span>人次
				</div>
				<div class="add">
					<span>参与人次：</span>
	...
	<?php if($v['status'] ==1):?>
	<div class="info clearfix" style="position:relative;top: 6px;">
