...
<div class="listItem">
	...
	<div class="content" style="height:38px;margin-bottom:8px;padding-top:5px;">
		<div class="header">
			<div class="name">
...
<!--				<div class="time" style="float:right">--><?//=date('Y-m-d H:i:s',$v['add_time'])?><!--</div>-->
	...
	<div class="content cloud clearfix" onClick="window.location.href='/yiyuan/UserCenter/ShareOrder?id=<?=$v['id']?>'">
		...
		<div class="details">
			...
			<!-- <div>
				<span style="float:left">2014-12-12 11:00</span>
				<span style="float:right;">
					<a style="color:#999;margin-right:8px;"><i style="background:url('{__STATIC_URL__}/public/yiyuan/new2016/images/btn_zan.png');margin-right: 6px;width: 16px;height: 16px;background-size: 100%;background-position: top center;background-repeat: no-repeat;display: inline-block;vertical-align: middle;"></i>赞</a>
					<a style="color:#999" class="<?php echo $v['comment']?'over-blue':'';?>"><i style="background:url('{__STATIC_URL__}/public/yiyuan/new2016/images/btn_comment.png');margin-right: 6px;width: 16px;height: 16px;background-size: 100%;background-position: top center;background-repeat: no-repeat;display: inline-block;vertical-align: middle;"></i><?php echo $v['comment']?"{$v['comment']}":'评论';?></a>
				</span>
			</div> -->
		</div>
	</div>
	<div class="foot-comm clearfix" style="margin-left:50px;margin-top:8px;">
...
<div class="cus-empty" id="mainContainer_empty">
	<div>
        <p>亲，您还没有晒单记录哦~</p>
        <a href="/yiyuan" class="cus-btn cus-btn-lg cus-btn-red" style="width:120px;">立即购买立即晒单</a>
