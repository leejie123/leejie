			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content no-padding" id="iframe-container">
						<iframe id="top-container" name="top-container" src="/shop/admin/product/ProductList/get" width="100%" height="100%" hspace="0" vspace="0" frameborder="0" scrolling="scroll"></iframe>
					</div>
				</div>
			</div>
		</div>
