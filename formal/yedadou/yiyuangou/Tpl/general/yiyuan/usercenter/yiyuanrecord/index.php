...
<title>一元购记录</title>
<link href="http://static.yedadou.com/public/yiyuan/general/css/myOrder.css" rel="stylesheet" type="text/css" />
</head>
<body>
<?php include $this->tpl('yiyuan:public/subscribe.php') ?>
<?php if(1==2){?>
<div class="user">
	<img alt="Susan't Avatar" src="http://static.yedadou.com/public/images/default_user.gif">
	<div class="name">游客<br>ID:33</div>
</div>
<?php } ?>
<nav id="menu" class="menu clearfix">
	<a class="over" href="/yiyuan/UserCenter/YiyuanRecord?status=going">全部</a>
	<a href="/yiyuan/UserCenter/YiyuanRecord?status=going">进行中</a>
	<a href="/yiyuan/UserCenter/YiyuanRecord?status=hit">已揭晓</a>
</nav>
