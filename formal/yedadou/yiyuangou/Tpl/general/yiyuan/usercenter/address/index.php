<?php include $this->tpl('shop:public/html_header.php') ?>
		<link rel="stylesheet" href="http://static.yedadou.com/public/??yiyuan/css/address.css,yiyuan/general/css/pub.css,yiyuan/ui/boboui.css,yiyuan/css/ico.css" />
		<title>收货地址</title>
	</head>
			...
			<div class="cart-container">
				<form id="dataForm" method="post" action="<?=$addressUrl?>" >
					...
					<div class="cart-not-empty">
						...
						<!--单个收货地址(START)-->
						<div class="address-list relative <?php if($v['is_default']!=1):?>hide<?php endif?>">
							<label class="radio2">
					...
					<div class="cart-empty text-center">
						<div class="cart-empty-info">
							<div class="cart-empty-image"><img src="http://static.yedadou.com/public/front/default/images/demo/icon/address-empty.png" alt="" /></div>
					...
					<div class="center address-buttons">
						...
						<?php endif?>
						<button id="synchronous" data-href="" class="button-green button-large"  style="background-color: #f60;" type="submit">同步微信地址</button>
					</div>
				</form>
			</div>
