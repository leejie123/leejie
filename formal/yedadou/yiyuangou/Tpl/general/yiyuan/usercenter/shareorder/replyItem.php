...
<div class="timeline-item clearfix">
	<div class="user">
		<img alt="Susan't Avatar" src="<?php $defaultAvatar = 'http://static.yedadou.com/public/images/default_user.gif'; echo !empty($v['avatar'])?substr($v['avatar'],0,strlen($v['avatar'])-1).'46':$defaultAvatar;?>">
	</div>
	<div class="info">
