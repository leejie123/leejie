...
<div class="listItem">
	<div class="user">
		...
		<img alt="Susan't Avatar" src="<?php $defaultAvatar = 'http://static.yedadou.com/public/images/default_user.gif'; echo !empty($v['avatar'])?substr($v['avatar'],0,strlen($v['avatar'])-1).'46':$defaultAvatar;?>" onClick="window.location.href='/yiyuan/ShopGoods/BuyRecord?buyer_id=<?=$v['uid']?>'">
		<?php } ?>
	</div>
	<div class="tip"></div>
	<div class="content">
