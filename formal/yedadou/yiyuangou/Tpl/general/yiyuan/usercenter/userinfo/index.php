<?php include $this->tpl('yiyuan:public/html_header.php') ?>
	<link rel="stylesheet" href="http://static.yedadou.com/public/??css/bootstrap.min.css,css/font-awesome.min.css" />
	<title>账号设置</title>
	<style type="text/css">
		#usrInfo{
			font-size: 16px;
	...
	<?php include $this->tpl('yiyuan:public/subscribe.php') ?>
		<div class="wrapper">
					<?php if(!$isEmpty):?>
					  ...
					  <div class="container">
					 	 <button type="submit" class="btn btn-warning btn-block" style="background-color: #f60;">确定</button>
					  </div>
					</form>
					<?php endif?>
