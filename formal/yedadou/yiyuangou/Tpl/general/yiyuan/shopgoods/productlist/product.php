...
<title>商品分类</title>
<link href="http://static.yedadou.com/public/yiyuan/css/product.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<script>
	$(function(){
		...
		//
		var urlPageList='/yiyuan/ShopGoods/ProductList?cid=<?=$cid;?>&sort=<?=$sort;?>&tag=<?=$tag;?>';
