...
<title>用户购买记录</title>
<link href="http://static.yedadou.com/public/yiyuan/css/myOrder.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div class="user">
	<!-- <img alt="Susan't Avatar" src="<?php $defaultAvatar = 'http://static.yedadou.com/public/images/default_user.gif'; echo !empty($buyer['avatar'])?substr($buyer['avatar'],0,strlen($buyer['avatar'])-1).'46':$defaultAvatar;?>"> -->
	<img alt="Susan't Avatar" src="<?php $defaultAvatar = 'http://static.yedadou.com/public/images/default_user.gif'; echo $defaultAvatar;?>">
