<?php if(!empty($data)){?>
	...
	<div class="listItem">
		<div class="row clearfix">
			...
			<div class="col3 proimg"  onclick='window.location.href="/yiyuan/ShopGoods/ProductDetails?id=<?=$v['goods_id'];?>&term_id=<?=$v['term_id']?>";' style="background-image: url(<?=$v['pic_url']?>_400x400.jpg)"><div class="tip">第（<?=$v['term']?>）期</div></div>
