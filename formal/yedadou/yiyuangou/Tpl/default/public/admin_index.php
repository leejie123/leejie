		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar responsive">
				...
				<div class="sidebar-shortcuts" id="sidebar-shortcuts">
					<div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large" style="text-align: left;margin-left: 5px; ">
						<button id="id-btn-home" class="btn btn-success" data-rel="tooltip" data-placement="top" data-url="/shop/admin/product/storeProductList/get" title="" data-original-title="首页">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content no-padding" id="iframe-container">
						<iframe id="top-container" name="top-container" src="/shop/admin/product/storeProductList/get" width="100%" height="100%" hspace="0" vspace="0" frameborder="0" scrolling="scroll"></iframe>
					</div>
				</div>
			</div>
		</div>
...
//     }]
// }];
		var sourceMenuUrl = '/shop/admin/getMenu';
		</script>
