										...
										<div class="pull-right clearfix">
											<div class="pull-left">
												<label>
													...
													<input type="text" placeholder="用户ID/昵称">
													<input type="text" placeholder="商品ID/标题">
												</label>
											</div>
								...
								<table id="dynamic-table" class="table table-striped table-bordered table-hover table-vertical-middle">
									...
									<tbody>
										...
										<tr id="row-1" data-id="oIIZ6s3zp-ZCdiEHiDI6GjGA6hc0" data-uid="1" data-authid="84bf1+uJ62Yry4B1BgFwhWxTyHAdGLvTZbHIgAoJ">
											...
											<td class="center">sdfjosifjsajfido</td>
											...
											<td>昵称（ID）</td>
											<td class="center">￥1.00元</td>
											<td class="center color-orange">2015-12-12 <br/> 12:12:12</td>
											<td class="center">进行中</td>
											<td class="center"><span class="color-orange">中奖</span></td>
											<td class="center">已支付</td>
											<td class="center">
												<a href="http://1047.m.yedadou.com/shop/test/index?tplName=orderlist" class="dispass line-h-15">订单详情</a>
											</td>
										</tr>
									</tbody>
								</table>
