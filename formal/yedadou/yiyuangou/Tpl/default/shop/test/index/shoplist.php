	...
	<body class="no-skin">
							...
							<div id="tab1" class="tab-pane active">
								...
								<div class="table-head-toolbar clearfix">
									<form method="post" action="" >
										<div class="pull-left">
											<a class="btn btn-info btn-sm"><i class="fa fa-plus"></i> 添加商品</a>
											<a class="btn btn-info btn-sm"><i class="fa fa-th"></i> 导入商城商品</a>
										</div>
								...
								<table id="dynamic-table" class="table table-striped table-bordered table-hover table-vertical-middle">
									...
									<tbody>
										...
										<tr id="row-1" data-id="oIIZ6s3zp-ZCdiEHiDI6GjGA6hc0" data-uid="1" data-authid="84bf1+uJ62Yry4B1BgFwhWxTyHAdGLvTZbHIgAoJ">
											...
											<td class="center color-orange">【数码】【手机】</td>
											<td class="center">
												4
											</td>
											<td class="center"><a href="">【人气】</a><br/><a href="">【推荐】</a></td>
											<td class="center color-orange">1</td>
											<td class="center"><span class="color-orange">1</span>/<span>100</span></td>
											<td class="center">1</td>
											<td class="center">100</td>
											<td class="">
												<a href="http://1047.m.yedadou.com/shop/test/index?tplName=editshoplist" class="dispass line-h-15">编辑</a>
												<a href="http://1047.m.yedadou.com/shop/test/index?tplName=oldissue">往期</a><br/>
												<a href="" data-click="del">删除</a>
												<a href="" data-click="editprice" data-url="http://1047.m.yedadou.com/shop/test/index?tplName=editprice">修改价格</a>
											</td>
										</tr>
									</tbody>
								</table>
		...
		<script type="text/javascript">
			$(function () {
				...
				$('a[data-click="editprice"]').on('click', function (e) {
					General.stopEvent(e);
					var url = $(this).data('url');
					General.showDialogWidthHeight('<i class="fa fa-info-circle"></i> 修改价格', url, 500, 0)
				})
