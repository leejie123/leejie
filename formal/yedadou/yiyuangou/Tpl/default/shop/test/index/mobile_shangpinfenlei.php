...
<html>
	...
	<body class="">
		<link rel="stylesheet" href="http://static.yedadou.com/public/css/mobile_shangpinfenlei.css" />
		<div class="wrapper">
			<!--公用头部开始 -->
			<!--公用头部开始 -->
			<!--购物车容器-->
			...
			<div class="cart-container">
				...
				<div class="tab-list">
					<ul>
						...
						<li data-toggle="#tab2" class="active">
							<a href="javascript:void(0);">
								<span class="">全部商品</span><span class="color-yellow bold">
						...
						<li data-toggle="#tab3">
							<a href="javascript:void(0);">
								<span class="">我的拼团</span><span class="red1 bold">
								0								
								</span>
							</a>
						</li>
											...
											<!-- <div style="min-height:30px;">该商品暂时没有属性</div> -->
								          	<span class="display-b red1">
								          		<span class="display-b">
								          			价值：
								          			<em class="quantity style-normal bold">4488</em>
								          		</span>
								          		<span>
								          			剩余： ￥<em class="red1">40件</em>
								          		</span>
								          	</span>
										</div>
				...
				<div id="tab3" class="cart-list-container tab-list-content">
					...
					<div class="cart-empty text-center" style="display:none">
						<div class="cart-empty-info">
							<div class="cart-empty-image">
								<img src="http://static.yedadou.com/public/front/default/images/demo/icon/order-empty.png" alt="" />
							</div>
					...
					<!-- 不为空 -->
					<div class="pt-item">
						<ul class="pt-item-content rFirst" style="height: auto;">
						    <li class="pt-item-media">
						    	<a href="">
						    		<img src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcSIpy4QBVQqv1S7B5K5j1314z-kvTvzNAfEU2Z1UhNrIDZXDucw">
						    	</a>
						    </li>
						    <li class="pt-item-inner">
						        <h4>(拼团ID)iPhone手机 土豪金 189寸。。。。</h4>
						        <h5>
						        	<span class="pull-left">价值：￥40.00</span>
						        	<span class="pull-right" style="margin-right: 20px;">已参与：300</span>
						        </h5>
						        <p name="pTime">
						            <!-- <s></s> -->
						            <i class="fa fa-clock-o"></i>
						            揭晓倒计时 
						            <strong style="font-size: 14px;"><em>02</em> : <em>44</em> : <em>4</em><em>7</em></strong>
						        </p>
						        <!-- <b class="fr z-arrow"></b> -->
						        <b class="fa fa-angle-right" style="font-size:18px;"></b>
						    </li>
						</ul>
...
<script>
	var url1 = '/yiyuan/pintuan/myGroups';
	var url1 = '/yiyuan/pintuan/allGoods';
