			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="tabbable">
						...
						<form method="post" action="/shop/SupplierAdmin/Settings/Freight/add" enctype="multipart/form-data" data-submit="auto">
							<div class="tab-content  padding-0 pt10">
								<div id="tab1" class="tab-pane active">
									...
									<div class="form-group">
										...
										<div class="control-wrapper">
											<select id="category1" data-tip="省份" multiple="multiple" size="10" name="area_select[]" id="duallist">
