                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group" style="margin-top: -8px;">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8" style="padding-top: 7px;">
                                            ...
                                            <label>
                                                <input name="char_pre" type="radio" class="ace" value="<?php echo $v['id']?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8">
                                            <input id="expireTime" name="password1" type="password" class="form-control" placeholder="" value="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8">
                                            <input id="expireTime" name="password2" type="password" class="form-control" placeholder="" value="">
                                        </div>
                                    </div>
                                </div>
                            </div>
