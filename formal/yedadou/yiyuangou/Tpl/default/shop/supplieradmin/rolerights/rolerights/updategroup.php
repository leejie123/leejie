        ...
        <div class="col-xs-12">
            ...
            <div class="tabbable">
                <ul class="nav nav-tabs padding-12 tab-color-blue">
                    ...
                    <li class="active">
                        <a data-toggle="tab" href="#tab1"><i class="ace-icon fa fa-plus"></i> 修改角色</a>
                    </li>
                </ul>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8">
                                            <input id="sceneName" name="name" type="text" class="form-control" placeholder="请输入角色的名称" value="<?php echo $res['name']?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-8">
                                                <label class="pos-rel mr20 item">
                                                    <input name="rights[<?php echo $a++ ?>]" type="checkbox"  <?php echo in_array($v['id'],$res['right'])?'checked':''?>  id="mdmgr-check-all" class="ace" value="<?php echo $v['id']?>">
                                                    <span class="lbl"> <strong><?php echo $v['text']?></strong></span>
                                                </label>
                                                <?php   foreach($v['child'] as $value):?>
                                                    <label class="pos-rel mr20">
                                                        <input name="rights[<?php echo $a++ ?>]" data-slect="<?php echo $v['id']?>" <?php echo in_array($value['id'],$res['right'])?'checked':''?> type="checkbox" class="ace" value="<?php echo $value['id']?>">
