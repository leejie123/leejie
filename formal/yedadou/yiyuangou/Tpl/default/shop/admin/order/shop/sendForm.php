				...
				<div class="col-xs-12">
					...
					<form method="post" action="" enctype="multipart/form-data" data-submit="auto">
						...
						<div class="button-panel">
							<button type="submit" class="btn btn-info btn-sm btn-space-right" data-href="/shop/admin/Order/Shop?order_id=<?=$order_id?>&order_sn=<?=$order_sn?>&optype=4&t=<?=$t?>" data-action="submit" data-refresh="parent" data-mask="parent"><i class='ace-icon fa fa-check'></i> 发货</button>
