	...
	<body class="no-skin">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
					<!--内容开始-->
					<form class="form-horizontal" method="post" action="/shop/admin/tag/tag/add">
					
						<div>
							<div class="panel-heading"><i class="fa fa-info-circle"></i> 添加一级栏目</div>
							<div class="form-group">
								<label class="col-xs-12 col-sm-3 col-md-2 control-label" for="sceneName"><strong>栏目名称</strong></label>
								<div class="col-xs-12 col-sm-6 col-md-8">
									<input id="sceneName" name="tag_name" type="text" class="form-control" placeholder="请输入栏目名称" value="">
								</div>
							</div>
							
						</div>
						<input type="hidden" name="goods_ids" id="checkedIds" value="" />
...
<!-- 										<th class="center" width="120">商品状态</th> -->
								...
								<tbody>
									...
									<tr id="row-0" data-id="<?=val($value,'id')?>" >
										<td class="center">
											<label class="pos-rel">
...
<!-- 										上架</td> -->
						...
						<div class="form-group" style="margin-top: 10px;">
							...
							<div class="col-xs-12 col-sm-6 col-md-8">
								<button class="btn btn-info btn-xs" style="margin-right: 50px;" id="submitBtn" type="submit"><i class="ace-icon fa fa-check"></i> 保存</button>
								<button class="btn btn-danger btn-xs"><i class="ace-icon fa fa-check"></i> 取消</button>
								<div class="space"></div>
							</div>
						</div>
					</form>
