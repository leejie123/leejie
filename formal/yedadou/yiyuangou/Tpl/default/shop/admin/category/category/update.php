	...
	<body class="no-skin">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
					<!--内容开始-->
					<form class="form-horizontal" method="post" action="/shop/admin/category/subCategory/update?id=<?=val($subCategory,'id')?>" >
						<div class="panel panel-default">
							<div class="panel-heading">更新子分类</div>
							<div class="panel-body">
								<div class="form-group">
									<label class="col-xs-12 col-sm-3 col-md-2 control-label" for="sceneName"><strong>分类名称</strong></label>
									<div class="col-xs-12 col-sm-6 col-md-8">
										<input id="sceneName" name="sub_cate_name" type="text" class="form-control" placeholder="请填写二级分类名称" value="<?=val($subCategory,'name')?>">
										<input type="hidden" id="sort_data" name="property" value="<?=val($subCategory,'property')?>" >
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-6 col-md-8">
										...
										<?php if(val($subCategory,'property')){
											$property = explode(',', $subCategory['property']);
												?>
											<?php foreach ($property as $value):?>
													<span class="btn btn-info btn-xs" data-click="del" style="margin-right:3px"><em><?=$value?></em> <i class="fa fa-close"></i></span>
											<?php endforeach;?>
											<?php }?>
										...
										<div class="block mg-b-15 form-control" id="attr_select" style="height:auto;">
											...
											<?php foreach ($propertys as $value):?>
