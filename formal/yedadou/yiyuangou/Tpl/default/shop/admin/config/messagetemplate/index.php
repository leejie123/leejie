								...
								<form class="form-horizontal" method="post" action="" enctype="multipart/form-data" id="msg_tpl_form" data-submit="auto">
									<div class="row">
												...
												<tbody>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<input type="text" id="newFollow" name="newFollow" class="form-control" value="<?php echo isset($msgTpl['newFollow']) ? $msgTpl['newFollow']:'';?>" placeholder="" />
													...
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<input type="text" id="notifySuper" name="notifySuper" class="form-control" value="<?php echo isset($msgTpl['notifySuper']) ? $msgTpl['notifySuper']:'';?>" placeholder="" />
																	<span class="input-group-addon" style="cursor:pointer">使用微信模板</span>
																</div>
															</div>
														</td>
													...
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<input type="text" id="paySuccess" name="paySuccess" class="form-control" value="<?php echo $msgTpl ? $msgTpl['paySuccess']:'';?>" placeholder="" />
																	<span class="input-group-addon" style="cursor:pointer">使用微信模板</span>
																</div>
															</div>
														</td>
													...
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<input type="text" id="paySuccessSuper" name="paySuccessSuper" class="form-control" value="<?php echo $msgTpl ? $msgTpl['paySuccessSuper']:'';?>" placeholder="" />
																	<span class="input-group-addon" style="cursor:pointer">使用微信模板</span>
																</div>
															</div>
														</td>
													...
													<tr>
														...
														<td>										    
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">																	
																		<select name="sendMessageToGroupId">
																		<option value="">不发送通知</option>
																		<?php foreach ($groupNames as $value){?>
																			<option value='<?php echo $value['gid']?>' <?php if($value['gid']==val($msgTpl,'sendMessageToGroupId')) echo 'selected'?>><?php echo $value['name']?></option>
																		<?php }?>
																    	
																	    </select>															    											    
																	<input type="text" id="sendMessageGroup" name="sendMessageGroup" class="form-control" value="<?php echo val($msgTpl,'sendMessageGroup','') ?>" placeholder="" />
																	<span class="input-group-addon" style="cursor:pointer">使用微信模板</span>
													...
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<input type="text" id="ship" name="ship" class="form-control" value="<?php echo $msgTpl ? $msgTpl['ship']:'';?>" placeholder="" />
																	<span class="input-group-addon" style="cursor:pointer">使用微信模板</span>
																</div>
															</div>
														</td>
													...
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<input type="text" id="complete" name="complete" class="form-control" value="<?php echo isset($msgTpl['complete']) ? $msgTpl['complete']:'';?>" placeholder="" />
																	<span class="input-group-addon" style="cursor:pointer">使用微信模板</span>
																</div>
															</div>
														</td>
													...
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<input type="text" id="completeSuper" name="completeSuper" class="form-control" value="<?php echo isset($msgTpl['completeSuper']) ? $msgTpl['completeSuper']:'';?>" placeholder="" />
																	<span class="input-group-addon" style="cursor:pointer">使用微信模板</span>
																</div>
															</div>
														</td>
													...
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<input disabled="disabled" type="text" id="refund" name="refund" class="form-control disabled" value="<?php echo isset($msgTpl['refund']) ? $msgTpl['refund']:'';?>" placeholder="" />
																	<span class="input-group-addon" style="cursor:pointer">使用微信模板</span>
																</div>
															</div>
														</td>
													...
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<input  disabled="disabled" type="text" id="refundSuper" name="refundSuper" class="form-control disabled" value="<?php echo isset($msgTpl['refundSuper']) ? $msgTpl['refundSuper']:'';?>" placeholder="" />
																	<span class="input-group-addon" style="cursor:pointer">使用微信模板</span>
																</div>
															</div>
														</td>
													...
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<input type="text" id="orderNotPay" name="orderNotPay" class="form-control" value="<?php echo isset($msgTpl['orderNotPay']) ? $msgTpl['orderNotPay']:'';?>" placeholder="" />
																	<span class="input-group-addon" style="cursor:pointer">使用微信模板</span>
																</div>
															</div>
														</td>
													...
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<input type="text" id="timeOut" name="timeOut" class="form-control" value="<?php echo isset($msgTpl['timeOut']) ? $msgTpl['timeOut']:'';?>" placeholder="" />
																	<span class="input-group-addon" style="cursor:pointer">使用微信模板</span>
																</div>
															</div>
														</td>
													...
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<input  disabled="disabled" type="text" id="upgrade" name="upgrade" class="form-control disabled" value="<?php echo isset($msgTpl['upgrade']) ? $msgTpl['upgrade']:'';?>" placeholder="" />
																	<span class="input-group-addon" style="cursor:pointer">使用微信模板</span>
																</div>
															</div>
														</td>
													...
													<tr>
														...
														<td>
															<div class="form-group no-margin-left no-margin-right mt4">
																<div class="input-group">
																	<input  disabled="disabled" type="text" id="upgradeSuper" name="upgradeSuper" class="form-control disabled" value="<?php echo isset($msgTpl['upgradeSuper']) ? $msgTpl['upgradeSuper']:'';?>" placeholder="" />
																	<span class="input-group-addon" style="cursor:pointer">使用微信模板</span>
																</div>
															</div>
														</td>
										...
										<div class="col-xs-6 line-height-30">
											...
											<div class="inner-content">
												恭喜你的粉丝【{$buyer_name}】成功购买{$amount_paid}元商品，订单完成后您将得到【{$commission}】元【{$type}】，分享赚钱，就这么简单，就这么任性！<br>
												商品数量只适应向购买者发送支付成功时的消息，其它类型消息默认为1

											</div>
										</div>
									</div>
									<div class="space"></div>
									<button class="btn btn-info" id="submitBtn" name="submitBtn" type="submit" data-href="/shop/admin/config/messageTemplate" data-action="submit" data-refresh="parent" data-mask="parent" ><i class="ace-icon fa fa-save"></i> 保存</button>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
