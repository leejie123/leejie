				...
				<div class="col-xs-12">
					...
					<div class="tabbable">
						...
						<form method="post" action="" enctype="multipart/form-data" data-submit="auto">
							...
							<div class="space"></div>
							<button class="btn btn-info" id="submitBtn" name="submitBtn" type="submit" data-href="/shop/admin/config/freight/add" data-action="submit" data-refresh="window" data-mask="parent" ><i class="ace-icon fa fa-save"></i> 保存</button>
							<div class="space"></div>
						</form>
					</div>
					<!--内容结束-->
