...
<!--											省-->
											<input type="hidden" name="province" id="<?=$store['province']?>" value="province"/>
<!--											市-->
											<input type="hidden" name="city" <?=$store['city']?>" value="city"/>
<!--											级-->
											<input type="hidden" name="area" id="<?=$store['area']?>" value="area"/>


											<select id="category1" name="province" data-tip="请选择省份" value="<?=$store['province']?>">
