                    ...
                    <div id="tab1" class="tab-pane active">
                        ...
                        <div class="table-head-toolbar clearfix">
                            <form method="get" action="" enctype="multipart/form-data">
                                <a class="btn btn-info btn-sm" id="add" href="/shop/admin/supplier/storeList/add"><i class="ace-icon fa fa-plus"></i> 新增门店</a>
                            ...
                            <?php if(!$isEmpty):?>
                                <?php foreach ($itemes as $arr):?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a href="/shop/admin/supplier/storeList/update?id=<?=$arr['id']?>" class="blue" data-id="manage">管理</a>&nbsp;&nbsp;

                                            <a href="/shop/admin/supplier/storeList/update?close=<?php echo $arr['status']?'1':'2';?>&id=<?=$arr['id']?>" class="blue" data-id="closeXXX"><?php echo $arr['status']?'关闭门店':'开启门店';?></a>&nbsp;&nbsp;
                                            <a href="/shop/admin/supplier/storeList/update?close=3&id=<?=$arr['id']?>" class="blue" data-id="closeXXX">删除门店</a>
                                        </td>
                                    </tr>
                                <?php endforeach?>
                            <?php endif?>
