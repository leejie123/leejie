				...
				<div class="col-xs-12">
					...
					<form method="post" action="" enctype="multipart/form-data" data-submit="auto">
						...
						<div class="button-panel">
							<button type="submit" class="btn btn-info btn-sm btn-space-right" data-href="/shop/admin/product/category/add" data-action="submit" data-refresh="parent" data-mask="parent"><i class='ace-icon fa fa-check'></i> 确定</button>
