...
<html>
	...
	<body class="no-skin">
				...
				<div class="col-xs-12">
					...
					<div class="tabbable">
						<ul class="nav nav-tabs padding-12 tab-color-blue">
							<li>
								<a href="/shop/admin/product/storeProductList/get">门店商品列表</a>
							</li>
							<li class="active">
								<a data-toggle="tab" href="#tab1"><i class="ace-icon fa fa-plus"></i> 添加门店商品</a>
							</li>
						</ul>

						<div class="tab-content no-border padding-0 pt10">
							<div id="tab1" class="tab-pane active">
								<form method="post" action="/shop/admin/product/addStoreProduct">
									...
									<div class="tabbable">
										...
										<div class="tab-content padding-0 pt10">
											...
											<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="control-wrapper short">
														<div>
															<label>
																<input name="shelf" type="radio" class="ace" value="1" checked>
																<span class="lbl"> 立即上架</span>
															</label>
															&nbsp;
															<label>
																<input name="shelf" type="radio" class="ace" value="2">
																<span class="lbl"> 暂不上架</span>
															</label>
															&nbsp;
															<label>
																<input name="shelf" type="radio" class="ace" value="3">
																<span class="lbl"> 定时上下架</span>
															</label>
														</div>
														<div id="shelfTimeContainer" class="time-container hide">
															<label class="" for="upTime">上架时间：</label>
															<input id="upTime" name="upTime" type="text" class=""> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
															<label class="" for="downTime">下架时间：</label>
															<input id="downTime" name="downTime" type="text" class="">
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="control-wrapper short">
														<div class="input-group ">
															<input type="text" value="" name="wx_price" id="wx_price" class="form-control" placeholder="">
												...
												<div class="form-group">
													...
													<div class="control-wrapper short">
														<div class="input-group ">
															<input type="text" value="" name="market_price" id="marketPrice" class="form-control" placeholder="">
															<span class="input-group-addon">元</span>
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="control-wrapper short">
														<div class="input-group ">
															<input type="text" value="" name="cost_price" id="costPrice" class="form-control" placeholder="">
															<span class="input-group-addon">元</span>
														</div>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="control-wrapper short">
														<table class="table table-striped table-bordered table-hover table-vertical-middle">
															<thead>
																<tr>
																	<th class="center" width="115"><input type="text" value="" name="sku_name[]" class="form-control" placeholder="属性如：颜色"></th>															
																	<th class="center" width="115"><input type="text" value="" name="sku_name[]" class="form-control" placeholder="属性如：尺寸"></th>
																	<th class="center" width="75">价格</th>
																	<th class="center" width="181">库存</th>
																	<th class="center" width="71">操作</th>
																</tr>
															</thead>
												...
												<div class="form-group">
													...
													<div class="control-wrapper short">
														<div class="input-group ">
															<input type="text" value="" name="wx_stock" id="wx_stock" class="form-control" placeholder="">
												...
												<div class="form-group">
													...
													<div class="control-wrapper short">
														<div class="input-group ">
															<input type="text" value="" name="sale_num" id="sale_num" class="form-control" placeholder="初始基数">
															<span class="input-group-addon">件</span>
														</div>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="control-wrapper">
														...
														<label class="pos-rel mr20">
																<input name="alone_freight" type="checkbox" class="ace" data-group="fix" value="1">
																<span class="lbl">独立运费</span>
																
														</label>
														<label id="alone_freight_fee" class="time-container hide">
															<input name="alone_freight_fee" type="text" value='' placeholder="0">&nbsp;元
														</label>
												...
												<div class="form-group">
													...
													<div class="control-wrapper short">
														...
														<label>
															<input name="limit" type="radio" class="ace" value="1" checked>
															<span class="lbl"> 不限购</span>
														</label>
														&nbsp;
														<label>
															<input name="limit" type="radio" class="ace" value="2">
															<span class="lbl"> 限购</span>
														</label>
														<label id="purchaseCount" class="time-container hide">
															<input name="limit_num" type="text" value=''>&nbsp;件
														</label>
													</div>
												</div>
											...
											<div id="t2" class="tab-pane active clearfix">
												<div class="form-group">
													...
													<div class="control-wrapper long">
														<textarea id="parameter" name="property" class="form-control height80" placeholder=""></textarea>
													</div>
												</div>
											</div>
											<div id="t4" class="tab-pane clearfix">
												<div class="form-group">
													...
													<div class="control-wrapper short">
														<label>
															<input name="is_commission" type="radio" class="ace" value="1">
															<span class="lbl"> 是</span>
														</label>
														&nbsp;&nbsp;&nbsp;
														<label>
															<input name="is_commission" type="radio" class="ace" value="2" checked>
												...
												<div class="form-group">
													...
													<div class="control-wrapper short">
														<label>
															<input id='commission_role_yes' name="commission_role" type="radio" class="ace" value="2" >
															<span class="lbl"> 是</span>
														</label>
														&nbsp;&nbsp;&nbsp;
														<label>
															<input id='commission_role_no' name="commission_role" type="radio" class="ace" value="1" checked>
															<span class="lbl"> 否</span>
														</label>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="control-wrapper short">
														<input id="base" name="commission" type="text" class="form-control" value="" placeholder="" />
														<  class="help-block">
															说明：佣金计算方式为：返佣基数*分佣比例，你也可以不设置返佣基数，系统默认商品单价为返佣基数。 
														</span>
													</div>
												</div>
												<div  id='fansCommission' style="display: none">
												<div class="form-group">
													<div class="label-wrapper">
													...
													<div class="control-wrapper short">
														<table class="table table-bordered">
															<tbody>
																...
																<?php 															   
																if(!empty($commission['agent']['grade']) && !empty($commission['agent']['percent'])){?>
																...
																<tr>
																	...
																	<td class="center">
																		<div class="input-group short">
																			<input type="text" value="<?php echo $commission['agent']['percent'][$key]; ?>" name="percent[]" class="form-control"><span class="input-group-addon">%</span>
																		</div>
																	</td>
																</tr>
																<?php endforeach;?>
										...
										<div id="t5" class="tab-pane clearfix">
												<div class="form-group" >
													...
													<div class="control-wrapper short">
														<input id="base" name="afterBuyPoint" type="text" value="<?php echo val($point,'integralGain5Enable',0)==1? val($point, 'integralGain5Num', 0):0;?>" style="width: 200px;"/>&nbsp;积分
													</div>
												</div>
												<div class="form-group" >
													<div class="label-wrapper">
													...
													<div class="control-wrapper short">
														<input id="base" name="afterSharePoint" type="text" value="<?php

														echo val($point,'integralGain4Enable',0)==1? val($point, 'integralGain4Num', 0):0;

														?>" style="width: 200px;" />&nbsp;积分
														<!--&nbsp;&nbsp;最多可获得:<input id="base" name="pointObtain" type="text" value="" style="width: 50px;" />&nbsp;次 *不限次数请不要输入-->
													</div>
												</div>
												<div class="form-group" >
													<div class="label-wrapper">
													...
													<div class="control-wrapper short">
														<input id="base" name="afterBuyPointToUse" type="text" value="0" style="width: 200px;" disabled />&nbsp;积分
													</div>
												</div>
											</div>
		...
		<table class="hide">
			<tbody id="tpl-parameter">
				<tr>
					...
					<td >
						<input class="sku_stock" type="text" value="" name="sku[stock][]" class="form-control" placeholder="">
					</td>
		...
		<script src="{__STATIC_URL__}/public/admin/js/shop/product/storeproduct/add.js"></script>
	</body>
