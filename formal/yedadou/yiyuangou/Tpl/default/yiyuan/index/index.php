...
<link href="{__STATIC_URL__}/public/yiyuan/css/index.css?v=201515" rel="stylesheet" type="text/css" />
</head>
<body>
...
<div class="indexMenuIcoContainer clearfix">
	<nav class="indexMenuIco clearfix">
		<a href="/yiyuan/ShopGoods/ProductList?sort=new">
			<img src="{__STATIC_URL__}/public/yiyuan/images/navico/ico1.jpg" alt="">
			<div class="title">分类</div>
		</a>
		<a href="/yiyuan/ShopGoods/ProductList?code_price=10">
			<img src="{__STATIC_URL__}/public/yiyuan/images/navico/ico2.jpg" alt="">
			<div class="title">10元专区</div>
		</a>
		<a href="/yiyuan/UserCenter/ShareOrder?act=show">
			<img src="{__STATIC_URL__}/public/yiyuan/images/navico/ico3.jpg" alt="">
			<div class="title">晒单</div>
		</a>
		<a href="http://mp.weixin.qq.com/s?__biz=MzA3ODQ4ODk1MQ==&mid=401113792&idx=1&sn=5ec6dc58c04b56755398ff63ec077f9d&scene=23&srcid=1216gqJ3Sbwd9ULbmz4x1a6O#rd">
			<img src="{__STATIC_URL__}/public/yiyuan/images/navico/ico4.jpg" alt="">
			<div class="title">常见问题</div>
		</a>
		<a href="/yiyuan/ShopGoods/ProductList?tag=tag_stocking">
			<img src="{__STATIC_URL__}/public/yiyuan/images/navico/ico5.jpg" alt="">
			<div class="title">年货专区</div>
		</a>
	</nav>
</div>
...
<script type="text/javascript">
	$(function(){
		...
		<?php foreach ($hit as $k=>$v):?>
			...
			var arrRadio=[
				'<a href="/yiyuan/ShopGoods/ProductDetails?id=<?=$v['goods_id'];?>&term=<?=$v['term'];?>" style="top:0">恭喜<span class="user"><?=$v['hit_nick']?></span>获得<?=$v['goods_title']?></a>',
			];
		...
		function doPage(loadendDo){
					...
					$btns.click(function(e){
						...
						if(currentType==4) $btns.eq(3).css('background-image','url(http://static.yedadou.com/public/yiyuan/images/indexsort.jpg)');
						if(currentType==5) $btns.eq(3).css('background-image','url(http://static.yedadou.com/public/yiyuan/images/indexsort-2.jpg)');
