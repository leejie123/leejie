				...
				<div class="col-xs-12">
					...
					<div class="tabbable">
						<ul class="nav nav-tabs padding-12 tab-color-blue">
							<li class="active">
								<a data-toggle="tab" href="#tab1">商品往期</a>
							</li>
						</ul>
								...
								<table id="dynamic-table" class="table table-striped table-bordered table-hover table-vertical-middle">
									...
									<tbody>
										...
										<?php foreach ($products as $key=>$value):?>
											...
											<td class="center" valign="middle"><?php echo $value['interval_time']?date('Y-m-d H:i',$value['interval_time']):'未限时';?></td>
											<td class="center"><?php echo $value['status_name'];?></td>
											<td class="center"><?php echo $value['hit_nick'];?></td>
											<td class="center"> 
												<a href="/yiyuan/admin/product/ProductPast/get?term_id=<?php echo $value['id'];?>" class="blue" data-id="edit">查看</a>
											</td>
										</tr>
										<?php endforeach;?>
										<?php }?>
