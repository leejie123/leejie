...
<div class="item clearfix" data-goodsid="<?=$v['goods_id'];?>" data-id="<?=$v['id'];?>" data-termid='<?=$v['term_id'];?>' id="cart-<?=$v['id'];?>">
	...
	<div class="proImg" style="background-image: url(<?php echo val($v, 'pic_url', '') ? $v['pic_url']: '{__STATIC_URL__}/public/yiyuan/tem/pro.jpg';?>);"></div>
	<div class="info clearfix">
		<a class="title" href="/yiyuan/ShopGoods/ProductDetails?id=<?=$v['goods_id'];?>"><?=$v['title'];?></a>
		<div class="other">
			<div class="right">
