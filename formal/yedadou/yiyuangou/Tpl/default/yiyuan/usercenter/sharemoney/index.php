...
<title>分享赚积分</title>
<link href="{__STATIC_URL__}/public/yiyuan/css/shareMoney.css?v=201512173" rel="stylesheet" type="text/css" />
</head>
<body>
<?php include $this->tpl('yiyuan:public/subscribe.php') ?>
	<div id="title">邀请好友成功一元购，可获得积分！</div>
	<div class="sharebtnContainer clearfix">
		<!-- <a href="/yiyuan/UserCenter/MyCard" class="btnGetMoney" style="float: left;">推广名片</a>
		<a id="btnGetMoney" class="btnGetMoney" style="float:right;">立即分享</a> -->
		<a id="btnGetMoney" class="btnGetMoney" style="float:none">立即分享</a>
	</div>
	<div id="mainContianer">
	    <nav id="menu" class="menu clearfix">
			<a id="nav1" href="#"><div class="title">直推(<?=val($treeData,'level1',0);?>)</div><div class="arrow-right"></div></a>
			<div class="pad" id="container1">
				
			</div>
			<div id="more1" class="more">加载更多</div>
			<a id="nav2" href="#"><div class="title">团队(<?=val($treeData,'level2',0)+val($treeData,'level3',0);?>)</div><div class="arrow-right"></div></a>
