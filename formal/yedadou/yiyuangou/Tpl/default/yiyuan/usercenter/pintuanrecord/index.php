...
<nav id="menu" class="menu clearfix">
	<a <?php if($con!=2){?>class="over"<?php }?> href="/yiyuan/UserCenter/PintuanRecord">购买记录</a>
	<a <?php if($con==2){?>class="over"<?php }?> href="/yiyuan/UserCenter/PintuanRecord?con=2">中奖记录</a>
</nav>
