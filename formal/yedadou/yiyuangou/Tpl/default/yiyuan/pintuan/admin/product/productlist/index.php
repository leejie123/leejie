								...
								<div class="table-head-toolbar clearfix">
									<form method="get" action="/yiyuan/pintuan/admin/product/productList/get" >
										<div class="pull-right clearfix">
											<div class="pull-left">
												<label>
													<input type="text" name="id" placeholder="商品ID" value="<?=val($search,'id','')?>">
													<input type="text" name="keywords" placeholder="商品名称/关键字" value="<?=val($search,'title','')?>">
												</label>
											</div>
											<div class='pull-left' style="margin: 0 10px;">
												...
												<div class="input-group input-daterange pull-left">
													<input id="startTime" name="startTime" type="text" class="form-control" value="<?=val($search,'start','')?>">
													<span class="input-group-addon">
														<i class="fa fa-exchange"></i>
													</span>
													<input id="endTime" name="endTime" type="text" class="form-control" value="<?=val($search,'end','')?>">
												</div>
											</div>
