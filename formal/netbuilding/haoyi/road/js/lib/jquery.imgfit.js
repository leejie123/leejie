...
(function(){
    ...
    if(!$.imgfitClass){
        $.imgfitClass = function($img,option){
            ...
            this.config             = { align : "c", fit : "all", canvasMode : false, position:'absolute', minWidth:undefined, minHeight:undefined, maxWidth:undefined, maxWidth:undefined, callBack : undefined, autoResize : true, lockTop:false };
            ...
            this.fit = function(){
                // if(this.parent.css('display') == 'none')console.log('none');
                ...
                if(this.config.lockTop)delete this.css.top;
    ...
    jQuery.fn.changeToCanvas = function(){
        var returnObj = [];        
        this.each(function(i){
            if($.imgfitModernizr.canvas){
                var img = $(this),
                    w   = img.width(),
                    h   = img.height(),
                    canvas,ctx;
                ...
                if(img[0].id)canvas.attr('id',img[0].id);
