...
(function(){
    CUBE = function(wrap,planes,size,option){
        ...
        this.init = function(){
            ...
            this.wrap.css({position:'absolute',left:'50%', top:'50%'});
            this.sizeChange();
        ...
        function onResize(){
            _this.size.width     = _this.parent.width();
            _this.size.height    = _this.parent.height();
            _this.size.depth     = this.direction = 'horizon'?_this.size.height:_this.size.width;
            _this.sizeChange(_this.size);
        }
/* ****************************************************************************************************************
...
**************************************************************************************************************** */
        ...
        this.sizeChange = function(size){
            ...
            for(var o in this.planes){
                ...
                if(this.planes[o])this.planes[o].css(css);
            }
