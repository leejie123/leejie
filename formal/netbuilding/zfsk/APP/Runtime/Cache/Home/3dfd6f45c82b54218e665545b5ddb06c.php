...
<section class="search-padding">
	<div class="container search-se">
		...
		<div class="row" style="
    text-align: center">
      <?php if(is_array($chazhao)): $i = 0; $__LIST__ = $chazhao;if( count($__LIST__)==0 ) : echo "对不起，无法搜索到符合你需求的房源，请注册会员，上传您的租房需求，专业团队会根据您的需求为您找房。" ;else: foreach($__LIST__ as $key=>$real): $mod = ($i % 2 );++$i;?><div class="col-md-4 mbtm">
       			<div class="imagebox">
                    ...
                    <?php if($real['status'] == 0): ?><div class="ribbon daishen"></div>
                    <?php else: ?>
                        <?php if($real[status] == 1): ?><div class="ribbon verified"></div>
                        <?php else: ?>
                           <div class="ribbon yizu"></div><?php endif; endif; ?>
                    </div>
                    <div class="tui_jian"><img src="__PUBLIC__/image/tuijian.png"></div>
                    </a>
                    <div class="onimage-content">
                       <ul>
                            <li>
                               <p>
                                  <span><i class="fa fa-map-marker"></i> <?php echo ($real["property"]["place_name"]); ?>&nbsp;<span><?php echo ($real["area"]); ?>m<sup>2</sup></span></span>
                                </p>
                            </li>
                            <li>
          ...
          </div><?php endforeach; endif; else: echo "对不起，无法搜索到符合你需求的房源，请注册会员，上传您的租房需求，专业团队会根据您的需求为您找房。" ;endif; ?>
    </div>
  </div>
      <div class="jingge">
        <?php echo ($Page); ?>
