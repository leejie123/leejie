 ...
 <!-- |---------------------------------------------------------| -->
  <form class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-md-8">
            <!-- <a href="<?php echo U('Staff/add');?>" class="btn btn-success">添加租赁专家</a> -->
          </div>
        </div>
       <table>
          <table class="table table-striped table-responsive datatable">
                ...
                <tbody>
                <?php if(is_array($staff)): $i = 0; $__LIST__ = $staff;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$staff): $mod = ($i % 2 );++$i;?><tr>
                      <td><?php echo ($staff["id"]); ?></td>
                      <td><?php echo ($staff["truename"]); ?></td>
                      <td><?php echo ($staff["phone"]); ?></td>
                      <td>
                        <?php if(is_array($staff['property_id'])): $i = 0; $__LIST__ = $staff['property_id'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; echo ($vo["district_name"]); ?>、<?php endforeach; endif; else: echo "" ;endif; ?>
                      </td>
                      <td><?php echo (mb_substr($staff["description"],0,50,'utf-8')); ?>...</td>
                      <td><?php echo ($staff["comment_grade"]); ?></td>
                      <td><a href="<?php echo U('Staff/evaluation',array('id' => $staff['id']));?>">查看评价</a></td>
                      <td><a href="<?php echo U('Staff/follow_up',array('id' => $staff['id']));?>">查看记录</a><span>/</span><a href="<?php echo U('Staff/xiugaipingxing',array('id' => $staff['id']));?>">修改评星</a></td>
                      <td><a href="<?php echo U('Staff/three_levels',array('id' => $staff['id']));?>">授权</a><span>/</span><a href="<?php echo U('Staff/update',array('id' => $staff['id']));?>">修改</a><span>/</span><a href="<?php echo U('Staff/delete',array('id' => $staff['id']));?>">删除</a></td>
