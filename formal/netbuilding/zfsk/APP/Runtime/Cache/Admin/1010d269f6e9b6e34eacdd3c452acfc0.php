...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
          <form class="form-horizontal" action="<?php echo U('My/uploadReal');?>" method="post" enctype="multipart/form-data">
              <fieldset>
                  ...
                  <div class="col-md-8"> 
                    <table class="table table-striped">
                      ...
                      <?php if(is_array($tupian)): $i = 0; $__LIST__ = $tupian;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tupian): $mod = ($i % 2 );++$i;?><tr>
                          ...
                          <td><a href="<?php echo U('My/deleteTupian',array('id' => $tupian['id']));?>">删除</a></td>
