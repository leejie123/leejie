  ...
  <form class="form-horizontal">
   <fieldset>
        <div class="form-group">
           ...
           <div class="col-md-4">
              <input placeholder="产品名称" class="form-control input-md" type="text" value="<?php echo ($vipactivity_detail["title"]); ?>" readonly>
           </div>
        </div>
        <div class="form-group">
           <label class="col-md-4 control-label">VIP用户名</label>
           <div class="col-md-4">
              <input placeholder="产品名称" class="form-control input-md" type="text" value="<?php echo ($vipactivity_detail["user"]["username"]); ?>" readonly>
           </div>
        </div>
        <div class="form-group">
           <label class="col-md-4 control-label">是否推荐</label>
           <div class="col-md-4">
              <?php if($vipactivity_detail['is_recommend'] == '1'): ?><input class="form-control input-md" type="text" value="是" readonly>
              <?php else: ?>
                  <input class="form-control input-md" type="text" value="否" readonly><?php endif; ?>
           </div>
        </div>
        <div class="form-group">
           <label class="col-md-4 control-label">发表时间</label>
           <div class="col-md-4">
              <input placeholder="产品名称" class="form-control input-md" type="text" value="<?php echo (date('Y-m-d H:i:s',$vipactivity_detail["create_time"])); ?>" readonly>
           </div>
        </div>
        <div class="form-group">
           <label class="col-md-4 control-label">信息类型</label>
           <div class="col-md-4">
              <input placeholder="产品名称" class="form-control input-md" type="text" value="<?php echo ($vipactivity_detail["cate"]["name"]); ?>" readonly>
           </div>
        </div>
        ...
        <div class="form-group" >
             ...
             <div class="col-md-8" >
                  <script id="editor" name="content" type="text/plain" style="width: 100%;height:500px;" readonly><?php echo ($vipactivity_detail["content"]); ?></script>
             </div>
        </div>
