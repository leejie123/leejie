...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
          <form class="form-horizontal" action="<?php echo U('My/addReal');?>" id="myform" method="post" enctype="multipart/form-data" >
 <!--       <div class="dropzone dz-clickable dz-started">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="direction" name="direction" class="form-control input-md"  type="text">
                </div>
              </div>
              <!-- Text input-->
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-md-4 control-label" >具体单位</label>  
                 <div class="col-md-4">
                <input id="building" name="building" class="form-control input-md"  type="text">
                </div>
              </div>
              <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="area" name="area" class="form-control input-md"  type="text">
                </div>
              </div>
              <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                  <input id="real_number" name="real_number" class="form-control input-md"  type="text">
                 </div> 
              </div>
              <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4"> 
                   <input id="hall_number" name="hall_number" class="form-control input-md"  type="text">
                </div>   
              </div>
                <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">                 
                   <input id="toilet_number" name="toilet_number" class="form-control input-md"  type="text">
                </div>
              </div>
                <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                   <input id="balcony" name="balcony" class="form-control input-md"  type="text">
                </div> 
              </div>
                <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="square_price" name="square_price" class="form-control input-md"  type="text">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="traffic" name="traffic" class="form-control input-md"  type="text">
                </div>
              </div>
                <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="furniture" name="furniture" class="form-control input-md"  type="text">
                </div>
              </div>
                    <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="facilities" name="facilities" class="form-control input-md"  type="text">
                </div>
              </div>  
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <textarea id="editor" name="description" type="text" style="width: 500px"></textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <textarea id="remarks" name="remarks"  class="form-control input-md"  type="text"></textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <button id="button1id" name="button1id" type="submit" class="btn btn-success">提交</button>
