       ...
       <table>
              <table class="table table-striped table-responsive datatable">
                    ...
                    <?php if(is_array($nodelist)): $i = 0; $__LIST__ = $nodelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                          <P style="text-indent:<?php echo ($vo['level']*20); ?>px"><label name="name" value=""><?php echo ($vo["title"]); ?></label></P>
                        </td>
                        <td><?php echo (searchdict($vo["status"],"OPEN_STATE","value")); ?></td>
                        <td><?php echo ($vo["sort"]); ?></td>
                        <td>
                          <?php if($vo['level'] == 1): ?>项目<?php endif; ?>
                          <?php if($vo['level'] == 2): ?><div style="color:green;">模块</div><?php endif; ?>
                          <?php if($vo['level'] == 3): ?><div style="color:blue;">操作</div><?php endif; ?>
                          <?php if($vo['level'] == 4): ?><div>功能</div><?php endif; ?>
                        </td>     
                        <td><a class="confirm-delete" href="<?php echo U('Rbac/deletenode',array('id' =>$vo['id']));?>">删除</a></td>
