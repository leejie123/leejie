 ...
 <!-- |---------------------------------------------------------| -->
  <form class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-md-8">
          <a href="<?php echo U('Real/add');?>" class="btn btn-success">添加房源</a>
        </div>
      </div>
       <table>
          <table class="table table-striped table-responsive datatable">
                ...
                <?php if(is_array($real)): $i = 0; $__LIST__ = $real;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$real): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td><?php echo ($real["district_name"]); ?></td>
                      ...
                      <td>
                        <?php if($real["status"] == 2): if($real["recommend"] == 0): ?><a href="<?php echo U('Real/recommend',array('id' =>$real['id'],'recommend' => '1'));?>">推荐</a><span>/</span>
                            <?php else: ?>
                              <a href="<?php echo U('Real/recommend',array('id' =>$real['id'],'recommend' => '0'));?>">取消推荐</a><span>/</span><?php endif; endif; ?>                  
                      <a href="<?php echo U('Real/upload',array('id' =>$real['id']));?>">上传图片</a><span>/</span><a href="<?php echo U('Real/update',array('id' =>$real['id']));?>">修改</a><span>/</span><a href="<?php echo U('Real/delete',array('id' =>$real['id']));?>">删除</a></td>
