...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
  <div class="container">
      <form class="form-horizontal" action="<?php echo U('Staff/addLevels');?>" method="post">
          <fieldset>
          <input type="hidden" value="<?php echo ($staff["id"]); ?>" name="id">

            <div class="form-group">
                <?php if(is_array($property)): $i = 0; $__LIST__ = $property;if( count($__LIST__)==0 ) : echo "暂无数据" ;else: foreach($__LIST__ as $key=>$property): $mod = ($i % 2 );++$i;?><div class="col-md-2">
                      <label class="checkbox-inline" for="checkboxes-0">
                      <input name="property_id[]"  value="<?php echo ($property["id"]); ?>" type="checkbox" <?php echo ($property['lis']?'checked':''); ?>><?php echo ($property["district_name"]); ?>
                      </label>
