 ...
 <!-- |---------------------------------------------------------| -->
  <form class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-md-8">
          <a href="<?php echo U('My/addtuijie');?>" class="btn btn-success">推介小区</a>
        </div>
      </div>
       <table>
          <table class="table table-striped table-responsive datatable">
                ...
                <tbody>
                <?php if(is_array($staff['property_id'])): $i = 0; $__LIST__ = $staff['property_id'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$property): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td><?php echo (date('Y-m-d',$property["construction_time"])); ?></td>
                      <td><?php echo ($property["volume_ratio"]); ?></td>                
                      <td><?php echo ($property["parking_space"]); ?></td>                  
                      <td><a href="<?php echo U('My/uploadProperty',array('id' =>$property['id']));?>">上传图片</a><span>/</span><a href="<?php echo U('My/updateProperty',array('id' =>$property['id']));?>">修改</a><span>/</span><a href="<?php echo U('My/deleteProperty',array('id' =>$property['id']));?>">删除</a></td>
