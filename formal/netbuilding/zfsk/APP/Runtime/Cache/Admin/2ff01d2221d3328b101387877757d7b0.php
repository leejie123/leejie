  ...
  <form class="form-horizontal">
       <table>
          <table class="table table-striped table-responsive datatable">
                ...
                <tbody>
                <?php if(is_array($advice_list)): $i = 0; $__LIST__ = $advice_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                      <td><?php echo ($vo["id"]); ?></td>
                      <td><?php echo ($vo["user"]["username"]); ?></td>
                      <td><?php echo ($vo["user"]["phone"]); ?></td>
                      <td><?php echo (mb_substr($vo["content"],0,30,'utf-8')); ?>...</td>
                      <th><?php echo ($vo["staff"]["truename"]); ?></th>
                      <td><?php echo (date('Y-m-d H:i:s',$vo["create_time"])); ?></td>
                      <td>
                      <a href="<?php echo U('User/complaint_detail',array('id' => $vo['id']));?>">详情</a><span>/</span><a href="<?php echo U('User/complaint_delete',array('id' => $vo['id']));?>">删除</a></td>
