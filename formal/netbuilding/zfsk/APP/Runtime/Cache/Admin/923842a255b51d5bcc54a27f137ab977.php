...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
          <form class="form-horizontal" action="<?php echo U('Real/upload');?>" method="post" enctype="multipart/form-data">
              <fieldset>
              <input type="hidden" value="<?php echo ($real_id); ?>" name="real_id">
              <div class="form-group">
                <label class="col-md-4 control-label" >图片上传(可多选)</label>  
                <div class="col-md-4">
                    <input id="file" name="image_url[]" class="form-control input-md" type="file" multiple>
                </div>
              </div>
                  ...
                  <div class="col-md-8"> 
                    <table class="table table-striped">
                      ...
                      <?php if(is_array($tupian)): $i = 0; $__LIST__ = $tupian;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tupian): $mod = ($i % 2 );++$i;?><tr>
                          ...
                          <td><a href="__PUBLIC__/upload/image/real/<?php echo ($tupian["image_url"]); ?>"><i class="fa fa-file-image-o"></i></a></td>
                          <td><a href="<?php echo U('Real/deleteTupian',array('id' => $tupian['id']));?>">删除</a></td>
