...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
          <form class="form-horizontal" action="<?php echo U('Staff/business');?>" method="post" enctype="multipart/form-data">
              <fieldset>
              <input value="<?php echo ($xiugai['id']); ?>" type="hidden" name="id">
              
               <div class="form-group">
                <label class="col-md-4 control-label" >选择租客账号</label>  
                <select style="margin: 0px 14px; padding: 4px; font-size: 12px;" name="user_id" id="user_id" >
                  <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><option style="padding: 0px 9px; font-size: 13px;" value="<?php echo ($user["id"]); ?>"><?php echo ($user["username"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
              <div class="form-group">
                <label class="col-md-4 control-label" >选择房源</label>  
                <select style="margin: 0px 14px; padding: 4px; font-size: 12px;" name="real_id" id="real_id" data-auto-value="<?php echo ($real['staff_id']); ?>">
                  <?php if(is_array($real)): $i = 0; $__LIST__ = $real;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$real): $mod = ($i % 2 );++$i;?><option style="padding: 0px 9px; font-size: 13px;" value="<?php echo ($real["id"]); ?>"><?php echo ($real["place_name"]); echo ($real["district_name"]); echo ($real["building"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
              <div class="form-group">
                <label class="col-md-4 control-label" >交易类型</label>  
                <select style="margin: 0px 14px; padding: 4px; font-size: 12px;" name="cate_id" id="cate_id" >
                  <?php if(is_array($real_cate)): $i = 0; $__LIST__ = $real_cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$real_cate): $mod = ($i % 2 );++$i;?><option style="padding: 0px 9px; font-size: 13px;" value="<?php echo ($real_cate["id"]); ?>"><?php echo ($real_cate["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
                
              <input type="hidden" value="<?php echo ($staff_id); ?>" name="staff_id">
                 <div class="form-group">
                    <label class="col-md-4 control-label" >上传身份证正面</label> 
                    <input type="file" name="identification_image_positive">
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label" >上传身份证背面</label>
                    <input type="file" name="identification_image_back">
                </div>
              <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >租客姓名</label>  
                 <div class="col-md-4">
                  <input id="truename" name="truename" class="form-control input-md"  type="text">  
                </div>
              </div>
              <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="phone" name="phone" class="form-control input-md"  type="text">
                </div>
              </div>
               <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="identification_card_num" name="identification_card_num" class="form-control input-md"  type="text">
                </div>
              </div>
