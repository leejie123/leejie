 ...
 <!-- |---------------------------------------------------------| -->
  <form class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-md-8">
          <a href="<?php echo U('Staff/business');?>" class="btn btn-success">添加交易</a>
        </div>
      </div>
       <table>
          <table class="table table-striped table-responsive datatable">
                ...
                <tbody>
                <?php if(is_array($business)): $i = 0; $__LIST__ = $business;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$business): $mod = ($i % 2 );++$i;?><tr>
                      <!-- <td><?php echo ($real["id"]); ?></td> -->
                      <td><?php echo ($business["uniqid"]); ?></td>
                      <td><?php echo ($business["user"]["username"]); ?></td>
                      <td><?php echo ($business["real"]["place_name"]); echo ($business["real"]["district_name"]); echo ($business["real"]["building"]); ?></td>
                      <td><?php echo ($business["cate"]["name"]); ?></td>
                      <td><?php echo ($business["identification_image_positive"]); ?></td>
                      <td><?php echo ($business["identification_image_back"]); ?></td>
                      <td><?php echo ($business["truename"]); ?></td>
                      <td><?php echo ($business["identification_card_num"]); ?></td>
                      <td><?php echo ($business["phone"]); ?></td>
                      <td><?php echo ($business["price"]); ?></td>
                      <td><?php echo (date('Y-m-d',$business["timestamp"])); ?></td>
                      <td><a href="<?php echo U('Staff/businessDelete',array('id' =>$business['id']));?>">删除</a></td>
