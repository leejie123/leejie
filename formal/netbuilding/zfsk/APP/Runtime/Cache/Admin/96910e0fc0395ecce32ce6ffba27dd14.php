...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
          <form class="form-horizontal" method="post" enctype="multipart/form-data">
              <fieldset>
              <input value="<?php echo ($property['id']); ?>" type="hidden" name="id">

              <div class="form-group">
                <label class="col-md-4 control-label" >小区名称</label>  
                 <div class="col-md-4">
                <input id="district_name" name="district_name" value="<?php echo ($property["district_name"]); ?>" class="form-control input-md"  type="text">    
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-4 control-label" >区域</label>  
                <div class="col-md-4">
                   <select name="area_id" data-auto-value="<?php echo ($property["area_id"]); ?>">
                       <option>请选择小区</option>
                       <?php if(is_array($area)): $i = 0; $__LIST__ = $area;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$area): $mod = ($i % 2 );++$i;?><option value="<?php echo ($area["id"]); ?>"><?php echo ($area["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   </select>
                </div>
              </div>
                <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="place_name" name="place_name" value="<?php echo ($property["place_name"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
                <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >开发商</label>  
                <div class="col-md-4">
                    <input id="developers" name="developers" value="<?php echo ($property["developers"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
          
                 <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >物业</label>  
                <div class="col-md-4">
                    <input id="property" name="property" value="<?php echo ($property["property"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
                 <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >物业类型</label>  
                <div class="col-md-4">
                    <input id="property_type" name="property_type" value="<?php echo ($property["property_type"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
                 <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >物业费</label>  
                <div class="col-md-4">
                    <input id="property_charges" name="property_charges" value="<?php echo ($property["property_charges"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
                    <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >总建面积</label>  
                <div class="col-md-4">
                    <input id="total_area" name="total_area" value="<?php echo ($property["total_area"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>   
              ...
              <div class="form-group">
                      ...
                      <div class="col-md-4">
                           <input class="form-control input-md date-picker" value="<?php echo ($property["construction_time"]); ?>" type="text" name="construction_time">
                      </div>
              </div>

              <div class="form-group">
                <label class="col-md-4 control-label" >总户数</label>  
                <div class="col-md-4">
                    <input id="total_households" name="total_households" value="<?php echo ($property["total_households"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
              <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >容积率</label>  
                <div class="col-md-4">
                    <input id="volume_ratio" name="volume_ratio" value="<?php echo ($property["volume_ratio"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
       
                <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >停车位</label>  
                <div class="col-md-4">
                    <input id="parking_space" name="parking_space" value="<?php echo ($property["parking_space"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <script id="editor" name="description" value="<?php echo ($property["description"]); ?>" type="text/plain" style="width: 100%; height: 200px;"></script>
                </div>
              </div>

                 <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >居</label>  
                <div class="col-md-4">
                    <textarea id="live" name="live" type="text/plain" value="<?php echo ($property["live"]); ?>" class="form-control input-md"></textarea>
                </div>
              </div>
                    <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <textarea id="travel" name="travel" value="<?php echo ($property["travel"]); ?>" type="text/plain" class="form-control input-md"></textarea>
                </div>
              </div>    
              <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >购</label>  
                <div class="col-md-4">
                    <textarea id="purchase" name="purchase" value="<?php echo ($property["purchase"]); ?>" type="text/plain" class="form-control input-md"></textarea>
                </div>
              </div>

              <div class="form-group" >
                 <label class="col-md-4 control-label">食</label>
                 <div class="col-md-4">
                  <textarea id="food" name="food" type="text/plain" value="<?php echo ($property["food"]); ?>" class="form-control input-md"></textarea>
                 </div>
              </div>
                  <div class="form-group" >
                 <label class="col-md-4 control-label">玩</label>
                 <div class="col-md-4">
                  <textarea id="play" name="play" type="text/plain" value="<?php echo ($property["play"]); ?>" class="form-control input-md"></textarea>
                 </div>
              </div>
              <!-- Button (Double) -->
              <div class="form-group">
