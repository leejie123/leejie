...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
          <form class="form-horizontal" action="<?php echo U('My/updateUser');?>" method="post" enctype="multipart/form-data">
              <fieldset>
              <input value="<?php echo ($userUpdate['id']); ?>" type="hidden" name="id">
              
              <div class="form-group" >
                 <label class="col-md-4 control-label">头像图片</label>
                 <div class="col-md-4">
                    <input type="file" class="input-file" name="top_image" value="<?php echo ($userUpdate["top_image"]); ?>">
                 </div>
              </div>
              <div class="form-group">
                <label class="col-md-4 control-label" >会员状态</label>  
                <div class="col-md-4"> 
                    <select name="status" data-auto-value="<?php echo ($real["status"]); ?>">
                        <option value="0">无求租</option>
                        <option value="1">求租</option>
                        <option value="2">实客</option>
                    </select>
                </div>
              </div>
              <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >账号</label>  
                 <div class="col-md-4">
                <input id="username" name="username" value="<?php echo ($userUpdate["username"]); ?>" class="form-control input-md"  type="text" readonly="">
              ...
              <div class="form-group">
                <label class="col-md-4 control-label" >新密码</label>  
                 <div class="col-md-4">
                <input id="password" name="password" value="<?php echo ($userUpdate["password"]); ?>" class="form-control input-md"  type="password">   
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-4 control-label" >昵称</label>  
                 <div class="col-md-4">
                <input id="nickname" name="nickname" value="<?php echo ($userUpdate["nickname"]); ?>" class="form-control input-md"  type="text">
                ...
                <label class="col-md-4 control-label" >邮箱</label>  
                 <div class="col-md-4">
                <input id="email" name="email" value="<?php echo ($userUpdate["email"]); ?>" class="form-control input-md"  type="text">
                  
                </div>
              </div>
              <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >QQ号码</label>  
                <div class="col-md-4">
                    <input id="qq_number" name="qq_number" value="<?php echo ($userUpdate["qq_number"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="phone" name="phone" value="<?php echo ($userUpdate["phone"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
                 <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >租房需求</label>  
                <div class="col-md-4">
                    <textarea id="demand" name="demand"  class="form-control input-md"  type="text"><?php echo ($userUpdate["demand"]); ?></textarea>
                </div>
              </div>
