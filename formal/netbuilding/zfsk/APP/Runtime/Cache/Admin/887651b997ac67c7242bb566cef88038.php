  ...
  <form class="form-horizontal">
       ...
       <fieldset>
          <table class="table table-striped">
                ...
                <?php if(is_array($evaluation)): $i = 0; $__LIST__ = $evaluation;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$evaluation): $mod = ($i % 2 );++$i;?><tr>
                      <td><?php echo ($evaluation["id"]); ?></td>
                      <td><?php echo ($evaluation["user"]["username"]); ?></td>
                      <td><?php echo ($evaluation["user"]["name"]); ?></td>
                      <td><?php echo ($evaluation["user"]["phone"]); ?></td>
                      <td><?php echo (searchdict($evaluation["comment_grade"],"EVALUATION_GRADE","value")); ?></td>
                      <td><?php echo ($evaluation["comment"]); ?></td>
                      <td><?php echo ($evaluation["cate"]["name"]); ?></td>
                      <!-- <td><?php echo ($staff["hall_number"]); ?></td> -->
                      <td><?php echo (date("Y-m-d H:i",$evaluation["timestamp"])); ?></td>
                      <td>
                      <a href="<?php echo U('Staff/updateComment',array('id' => $evaluation['id']));?>">修改</a><span>/</span><a href="<?php echo U('Staff/deleteComment',array('id' => $evaluation['id']));?>">删除</a></td>
