      ...
      <div class="form-group">
       ...
       <table>
          <table class="table table-striped table-responsive datatable">
                ...
                <tbody>
                <?php if(is_array($romotion)): $i = 0; $__LIST__ = $romotion;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$romotion): $mod = ($i % 2 );++$i;?><tr>
                      <td><a href="<?php echo U('Home/Real/real_neiye',array('id' => $romotion['id']));?>"><?php echo ($romotion["id"]); ?></a></td>
                      <td><?php echo ($romotion["district_name"]); ?></td>
                      <td><?php echo ($romotion["area_id"]); ?></td>
                      <td><?php echo ($romotion["place_name"]); ?></td>
                      <td><?php echo ($romotion["developers"]); ?></td>
                      <td><?php echo ($romotion["property"]); ?></td>
                      <td><?php echo ($romotion["property_type"]); ?></td>
                      <td><?php echo ($romotion["property_charges"]); ?></td>
                      <td><?php echo ($romotion["total_area"]); ?></td>
                      <td><?php echo ($romotion["total_households"]); ?></td>
                      <td><?php echo (date('Y-m',$romotion["construction_time"])); ?></td>
                      <td><?php echo ($romotion["volume_ratio"]); ?></td>
                      <td><?php echo ($romotion["parking_space"]); ?></td>
                      <td><?php echo ($romotion["staff"]["truename"]); ?></td>
                      <td><a href="<?php echo U('Property/update',array('id' =>$romotion['id']));?>">修改</a><span>/</span><a href="<?php echo U('Property/delete',array('id' =>$romotion['id']));?>">删除</a></td>
