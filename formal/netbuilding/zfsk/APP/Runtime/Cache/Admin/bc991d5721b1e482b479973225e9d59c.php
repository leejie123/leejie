...
<html>
  ...
  <link rel="stylesheet" href="__PUBLIC__/css/dataTables.bootstrap.min.css">
 ...
 <!-- |---------------------------------------------------------| -->
  <form class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-md-8">
          <a href="<?php echo U('My/addReal');?>" class="btn btn-success">推介房源</a>
        </div>
      </div>
       <div class="table">
          <table class="table table-striped table-responsive datatable">
              ...
              <tbody>
                <?php if(is_array($real)): $i = 0; $__LIST__ = $real;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$real): $mod = ($i % 2 );++$i;?><tr>
                      <!-- <td><?php echo ($real["id"]); ?></td> -->
                      <td><a href="<?php echo U('Home/Real/real_neiye',array('id' => $real['id']));?>"><?php echo ($real["uniqid"]); ?></a></td>
                      <td><?php echo ($real["property"]["district_name"]); ?></td>
                      <td><?php echo ($real["direction"]); ?></td>
                      <td><?php echo (searchdict($real["renovation"],"RENOVATION","value")); ?></td>
                      <td><?php echo ($real["place_name"]); ?></td>
                      <td><?php echo ($real["building"]); ?></td>
                      <td><?php echo (date('Y-m-d',$real["construction_time"])); ?></td>
                      <td><?php echo ($real["area"]); ?></td>
                      <td><?php echo ($real["real_number"]); ?></td>
                      <td><?php echo ($real["hall_number"]); ?></td>
                      <td><?php echo ($real["toilet_number"]); ?></td>
                      <td><?php echo ($real["balcony"]); ?></td>
                      <td><?php echo (date("Y-m-d",$real["timestamp"])); ?></td>
                      <td><?php echo ($real["price"]); ?></td>
                      <td><a href="<?php echo U('');?>"><?php echo ($real["name"]); ?></a></td>
                      <td><?php echo ($real["phone"]); ?></td>
                      <td><?php echo (searchdict($real["status"],"RENT_STATE","value")); ?></td>
                      <td><?php echo ($real["remarks"]); ?></td>
                      <td>
                        <?php if($real["release_status"] == 1): ?><a href="<?php echo U('My/release_status',array('id' =>$real['id'],'release_status' => 0));?>">下架</a><span>/</span>
                        <?php else: ?>
                            <a href="<?php echo U('My/release_status',array('id' =>$real['id'],'release_status' => 1));?>">发布</a><span>/</span><?php endif; ?>
                      <a href="<?php echo U('My/yizu',array('id' =>$real['id']));?>">更改状态</a><span>/</span>        
                      <a href="<?php echo U('My/uploadReal',array('id' =>$real['id']));?>">上传图片</a><span>/</span><a href="<?php echo U('My/myrealupdate',array('id' =>$real['id']));?>">修改</a><span>/</span><a href="<?php echo U('My/realdelete',array('id' =>$real['id']));?>">删除</a></td>
...
<!--  |---------------------------------------------------------| -->
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        $('.datatable').DataTable({
          "language": {
                "url": "__PUBLIC__/js/Chinese.json"
            }
        });
    });
    </script>
