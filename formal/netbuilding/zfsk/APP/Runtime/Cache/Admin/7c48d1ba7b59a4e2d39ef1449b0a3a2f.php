...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
          <form class="form-horizontal" method="post" action="<?php echo U('Login/updatePassword');?>" enctype="multipart/form-data">
 ...
 -->
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                   <input id="password" name="password" value="<?php echo ($staffUpdate["phone"]); ?>" class="form-control input-md"  type="password">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                   <input id="passwords" name="passwords" value="<?php echo ($staffUpdate["phone"]); ?>" class="form-control input-md"  type="password">
                </div>
              </div>
