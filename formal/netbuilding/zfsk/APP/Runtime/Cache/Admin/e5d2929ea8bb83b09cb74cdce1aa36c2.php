  ...
  <form class="form-horizontal">
       ...
       <table>
         <table class="table table-striped table-responsive datatable">
                ...
                <tbody>
                <?php if(is_array($trial)): $i = 0; $__LIST__ = $trial;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$trial): $mod = ($i % 2 );++$i;?><tr>
                      <td><?php echo ($trial["id"]); ?></td>
                      <td><?php echo ($trial["username"]); ?></td>
                      <td><?php echo ($trial["nickname"]); ?></td>
                      <td><?php echo (date('Y-m-d',$trial["timestamp"])); ?></td>
                      <td><?php echo ($trial["email"]); ?></td>
                      <td><?php echo ($trial["qq_number"]); ?></td>
                      <td><?php echo ($trial["phone"]); ?></td>
                      <td><?php echo (mb_substr($trial["demand"],0,50,'utf-8')); ?>..</td>
                      <td><?php echo (searchdict($trial["group"],"IS_MEMBER","value")); ?></td>
                      <td><?php echo ($trial["staff"]["truename"]); ?></td>
                      <td><a href="<?php echo U('User/shenyue',array('id' =>$trial['id']));?>">更改负责人</a></td>
