 ...
 <!-- |---------------------------------------------------------| -->
  <form class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-md-8">
           <!--  <a href="<?php echo U('User/add');?>" class="btn btn-success">添加会员</a> -->
          </div>
        </div>
       <table>
          <table class="table table-striped table-responsive datatable">
                ...
                <tbody>
                <?php if(is_array($vip_user)): $i = 0; $__LIST__ = $vip_user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr>
                      <td><?php echo ($user["id"]); ?></td>
                      <td><?php echo ($user["username"]); ?></td>
                      <td><?php echo ($user["nickname"]); ?></td>
                      <td><?php echo ($user["name"]); ?></td>
                      <td><?php echo (date('Y-m-d',$user["timestamp"])); ?></td>
                      <td><?php echo ($user["email"]); ?></td>
                      <td><?php echo ($user["phone"]); ?></td>
                      <td><?php echo ($user["qq_number"]); ?></td>
                      <td><?php echo (mb_substr($user["demand"],0,50,'utf-8')); ?>..</td>
                      <td><?php echo (searchdict($user["group"],"IS_MEMBER","value")); ?></td>
                      <td><?php echo ($user["remarks"]); ?></td>
                      <td>
                      <a href="<?php echo U('My/shenheuser',array('id' =>$user['id']));?>">修改会员身份</a><span>/</span><a href="<?php echo U('User/update',array('id' =>$user['id']));?>">修改</a><span>/</span><a href="<?php echo U('User/delete',array('id' =>$user['id']));?>">删除</a></td>
