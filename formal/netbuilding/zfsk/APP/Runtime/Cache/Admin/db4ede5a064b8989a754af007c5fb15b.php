...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
  <div class="container">
      <form class="form-horizontal" action="<?php echo U('Property/addLevels');?>" method="post">
          <fieldset>
          <input type="hidden" value="<?php echo ($property["id"]); ?>" name="id">

            <div class="form-group">
                <?php if(is_array($staff)): $i = 0; $__LIST__ = $staff;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$staff): $mod = ($i % 2 );++$i;?><div class="col-md-2">
                      <label class="checkbox-inline" for="checkboxes-0">
                      <input name="staff_id[]"  value="<?php echo ($staff["id"]); ?>" type="checkbox" <?php echo ($staff['ccc']?'checked':''); ?>><?php echo ($staff["truename"]); ?>
