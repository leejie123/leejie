...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
  <form class="form-horizontal" method="post" action="<?php echo U('User/vipactivity_save');?>">
   <fieldset>
        <input type="hidden" name="id" value="<?php echo ($vipactivity_detail["id"]); ?>">
        <div class="form-group">
           <label class="col-md-4 control-label">标题</label>
           <div class="col-md-4">
              <input name="title" placeholder="标题" class="form-control input-md" type="text" value="<?php echo ($vipactivity_detail["title"]); ?>">
           </div>
        </div>
        <div class="form-group">
           <label class="col-md-4 control-label">VIP用户名</label>
           <div class="col-md-4">
              <input placeholder="VIP用户名" class="form-control input-md" type="text" value="<?php echo ($vipactivity_detail["user"]["username"]); ?>" readonly>
           </div>
        </div>
       
            <div class="form-group">
                    <label class="col-md-4 control-label" for="chanpinleibie">是否推荐</label>
                    <div class="col-md-4">
                        <select id="chanpinleibie" name="is_recommend" class="form-control" data-auto-value="<?php echo ($vipactivity_detail["is_recommend"]); ?>">
        ...
        <div class="form-group">
                    <label class="col-md-4 control-label" for="chanpinleibie">信息类型</label>
                    <div class="col-md-4">
                        <select id="chanpinleibie" name="cate_id" class="form-control" data-auto-value="<?php echo ($vipactivity_detail["cate_id"]); ?>">
        ...
        <div class="form-group" >
             ...
             <div class="col-md-4" >
                  <script id="editor" name="content" type="text/plain" style="width: 100%;height:500px;"><?php echo ($vipactivity_detail["content"]); ?></script>
             </div>
        </div>
