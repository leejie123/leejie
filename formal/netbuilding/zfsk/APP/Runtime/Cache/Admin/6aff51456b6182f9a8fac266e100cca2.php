...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
          <form class="form-horizontal" action="<?php echo U('Staff/updateComment');?>" method="post" enctype="multipart/form-data">
         
              <fieldset>
              <input value="<?php echo ($comment['id']); ?>" type="hidden" name="id">
           <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >评论等级</label>  
                <div class="col-md-4">
                    <select name="comment_grade" data-auto-value="<?php echo ($comment["comment_grade"]); ?>">
            ...
            <div class="form-group">
                ...
                <select style="margin: 0px 14px; padding: 4px; font-size: 12px;" name="cate_id" id="cate_id" data-auto-value="<?php echo ($comment["cate_id"]); ?>">
                  <?php if(is_array($real_cate)): $i = 0; $__LIST__ = $real_cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$real_cate): $mod = ($i % 2 );++$i;?><option style="padding: 0px 9px; font-size: 13px;" value="<?php echo ($real_cate["id"]); ?>"><?php echo ($real_cate["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   ...
                   <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >评论内容</label>  
                <div class="col-md-4">
                    <textarea id="comment" name="comment"  class="form-control input-md"  type="text"><?php echo ($comment["comment"]); ?></textarea>
                </div>
              </div>
