...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
          <form class="form-horizontal" method="post" action="<?php echo U(Staff/xiugaipingxing);?>" enctype="multipart/form-data">
          
               <fieldset>
                  <input value="<?php echo ($staff[0]['id']); ?>" type="hidden" name="id">
                  <div class="form-group">
                    <label class="col-md-4 control-label" >评星等级</label>  
                    <div class="col-md-4"> 
                        <select name="comment_grade" data-auto-value="<?php echo ($real["comment_grade"]); ?>">
