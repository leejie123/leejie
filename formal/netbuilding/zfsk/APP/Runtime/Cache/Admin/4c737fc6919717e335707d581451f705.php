...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
  <form class="form-horizontal">
       <fieldset>
          <div class="form-group">
           <label class="col-md-4 control-label">投诉人</label>
           <div class="col-md-4">
              <input placeholder="产品名称" class="form-control input-md" type="text" value="<?php echo ($complaint_detail["user"]["username"]); ?>" readonly>
           </div>
        </div>

        <div class="form-group">
           <label class="col-md-4 control-label">投诉人联系电话</label>
           <div class="col-md-4">
              <input placeholder="产品名称" class="form-control input-md" type="text" value="<?php echo ($complaint_detail["user"]["phone"]); ?>" readonly>
           </div>
        </div>

        <div class="form-group">
           <label class="col-md-4 control-label">提交时间</label>
           <div class="col-md-4">
              <input placeholder="产品名称" class="form-control input-md" type="text" value="<?php echo (date('Y-m-d H:i:s',$complaint_detail["create_time"])); ?>" readonly>
           </div>
        </div>

        <div class="form-group" >
             <label class="col-md-4 control-label">投诉与建议内容</label>
             <div class="col-md-4" >
                  <textarea type="text" class="form-control" style="width:465px;height:235px;" readonly><?php echo ($complaint_detail["content"]); ?></textarea>
             </div>
        </div>
       </fieldset>
   </form>       
