...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
          <form class="form-horizontal" method="post" enctype="multipart/form-data">
              <fieldset>
              <input value="<?php echo ($userUpdateUser['id']); ?>" type="hidden" name="id">
               <div class="form-group">
                <label class="col-md-4 control-label" >申请会员身份</label>  
                <div class="col-md-4"> 
                    <select name="group">
                       <?php if($userUpdateUser['group'] != 0): ?><option value="0">普通会员</option><?php endif; ?>
                       <?php if($userUpdateUser['group'] != 1): ?><option value="1">验证会员</option><?php endif; ?>
                       <?php if($userUpdateUser['group'] != 2): ?><option value="2">VIP会员</option><?php endif; ?>
                    </select>
                </div>
              </div>
