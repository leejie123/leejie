...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
 <form class="form-horizontal" action="<?php echo U('Real/tongguo',array('id' => $real['id']));?>" method="post" enctype="multipart/form-data">
              ...
              <p>点击空白处添加图片</p>
                ...
                <div class="dz-preview dz-processing dz-image-preview dz-error dz-complete">  
                  <div class="dz-error-message">
                    <span data-dz-errormessage="">&lt;html&gt;
                  ...
                  <input style="visibility: hidden; position: absolute; top: 0px; left: 0px; height: 0px; width: 0px;" class="dz-hidden-input" multiple="multiple" type="file" name="image_url">
                </div>
              </div> -->
              <fieldset>
              <input value="1" type="hidden" name="status">
                ...
                <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >分配租赁专家</label>  
                <select style="margin: 0px 14px; padding: 4px; font-size: 12px;" name="staff_id" id="staff_id" data-auto-value="<?php echo ($real['staff_id']); ?>">
                  <?php if(is_array($staff)): $i = 0; $__LIST__ = $staff;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$staff): $mod = ($i % 2 );++$i;?><option style="padding: 0px 9px; font-size: 13px;" value="<?php echo ($staff["id"]); ?>"><?php echo ($staff["truename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>

                 <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >房源ID</label>  
                <div class="col-md-4">
                    <input id="uniqid" name="uniqid" value="<?php echo ($real["uniqid"]); ?>" class="form-control input-md"  type="text" readonly="">
                </div>
              </div>
                 <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="district_name" name="district_name" value="<?php echo ($real["district_name"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
                 <!-- Text input-->
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="renovation" name="renovation" value="<?php echo ($real["renovation"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
              <!-- Text input-->
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-md-4 control-label" >建造时间</label>  
                 <div class="col-md-4">
                <input id="construction_time" name="construction_time" value="<?php echo (date('Y-m-d',$real["construction_time"])); ?>" class="form-control input-md"  type="text">  
              </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                  <input id="real_number" name="real_number" class="form-control input-md"  type="text" value="<?php echo ($real["real_number"]); ?>">
                 </div> 
              </div>
              <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4"> 
                   <input id="hall_number" name="hall_number" class="form-control input-md"  type="text" value="<?php echo ($real["hall_number"]); ?>">
                </div>   
              </div>
                <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">                 
                   <input id="toilet_number" name="toilet_number" class="form-control input-md"  type="text" value="<?php echo ($real["toilet_number"]); ?>">
                </div>
              </div>
                <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                   <input id="balcony" name="balcony" class="form-control input-md"  type="text" value="<?php echo ($real["balcony"]); ?>">
                </div> 
              </div>
                <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >上传时间</label>  
                <div class="col-md-4">
                    <input id="timestamp" name="timestamp" value="<?php echo (date("Y-m-d",$real["timestamp"])); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
                <!-- Text input-->
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <textarea id="remarks" name="remarks" value="<?php echo ($real["remarks"]); ?>" class="form-control input-md"  type="text"></textarea>
                </div>
              </div>
