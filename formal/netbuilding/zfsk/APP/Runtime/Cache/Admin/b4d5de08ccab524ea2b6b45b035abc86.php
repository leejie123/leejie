...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
          <form class="form-horizontal" action="<?php echo U('Property/add');?>" method="post" enctype="multipart/form-data">
              <fieldset>
              <input value="<?php echo ($xiugai['id']); ?>" type="hidden" name="id">

              <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >小区名称</label>  
                 <div class="col-md-4">
                <input id="district_name" name="district_name" class="form-control input-md"  type="text">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="place_name" name="place_name" class="form-control input-md"  type="text">
                </div>
              </div>
                <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="developers" name="developers" class="form-control input-md"  type="text">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="property" name="property" class="form-control input-md"  type="text">
                </div>
              </div>
                 <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="property_type" name="property_type" value="<?php echo ($xiugai["title"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
                 <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="property_charges" name="property_charges" class="form-control input-md"  type="text">
                </div>
              </div>
                    <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="total_area" name="total_area" class="form-control input-md"  type="text">
                </div>
              </div>    
              <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="total_households" name="total_households" class="form-control input-md"  type="text">
                </div>
              </div>
              <!-- Text input-->
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="volume_rate" name="volume_rate" class="form-control input-md"  type="text">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="parking_space" name="parking_space" class="form-control input-md"  type="text">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <script id="editor" name="description" type="text/plain" style="width: 100%; height: 200px;"></script>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <textarea id="live" name="live" type="text/plain" class="form-control input-md"></textarea>
                </div>
              </div>
                    <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <textarea id="travel" name="travel" type="text/plain" class="form-control input-md"></textarea>
                </div>
              </div>    
              <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <textarea id="purchase" name="purchase" type="text/plain" class="form-control input-md"></textarea>
                </div>
              </div>
              ...
              <div class="form-group" >
                 ...
                 <div class="col-md-4">
                  <textarea id="food" name="food" type="text/plain" class="form-control input-md"></textarea>
                 </div>
              </div>
                  <div class="form-group" >
                 <label class="col-md-4 control-label">玩</label>
                 <div class="col-md-4">
                  <textarea id="play" name="play" type="text/plain" class="form-control input-md"></textarea>
                 </div>
              </div>
              <!-- Button (Double) -->
              <div class="form-group">
