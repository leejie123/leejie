...
<form class="form-horizontal">
  ...
  <div><div class="col-lg-10"></div><div class="col-lg-1"><a href="<?php echo U('My/updateStaff',array('id' => $staff['id']));?>">编辑修改</a></div></div>
        <table class="table table-bordered">
          ...
          <tr>
            <td><?php echo ($staff["truename"]); ?></td> 
            <td><p>手机：<?php echo ($staff["phone"]); ?></p><p>微信：<?php echo ($staff["wechat"]); ?></p><p> 其他联系方式：<?php echo ($staff["other"]); ?></p></td>
            <td><p><img src="<?php if($staff['top_image'] == ''): ?>__PUBLIC__/Admin/dist/img/user2-160x160.jpg<?php else: ?>__PUBLIC__/upload/image/real/<?php echo ($staff["top_image"]); endif; ?>" style="width: 100px;"></p></td>
            <td><?php if(is_array($staff['property_id'])): $i = 0; $__LIST__ = $staff['property_id'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; echo ($vo["district_name"]); ?><br /><?php endforeach; endif; else: echo "" ;endif; ?></td>
          </tr>
        </table>
    ...
    <!-- 配置文件 -->
        ...
        <div class="form-group">
          <label class="col-md-3 control-label" for="">个人介绍：</label><br />
          <div class="col-md-6">                     
       ...
       <div class="form-group">
          ...
          <div class="col-md-8"> 
            <table class="table table-striped table-responsive datatable">
                ...
                <tbody>
              <?php if(is_array($follow_up)): $i = 0; $__LIST__ = $follow_up;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$follow_up): $mod = ($i % 2 );++$i;?><tr>
                  <td><?php echo (date('Y-m-d H:i',$follow_up["timestamp"])); ?></td>
                  <td><?php echo ($follow_up["caozuo"]); echo ($follow_up["staff_id"]); echo ($follow_up["content"]); ?></td>
