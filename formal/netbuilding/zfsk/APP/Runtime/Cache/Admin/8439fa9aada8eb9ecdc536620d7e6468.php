...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
          <form class="form-horizontal" action="<?php echo U('Property/promotion');?>" method="post" enctype="multipart/form-data">
              <fieldset>
              <input value="<?php echo ($id); ?>" type="hidden" name="staff_id">
              <input value="1" type="hidden" name="romotion">
              ...
              <div class="form-group">
                <label class="col-md-4 control-label" >建造时间</label>  
                 <div class="col-md-4">
                <input id="construction_time" name="construction_time" class="form-control input-md"  type="text">
              ...
              <!-- add1/ -->
                 ...
                 <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >推介理由</label>  
                <div class="col-md-4">
                    <textarea id="promote_reason" name="promote_reason" type="text/plain" style="width: 100%; height: 200px;"></textarea>
                </div>
              </div>
