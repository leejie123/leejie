...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
          <form class="form-horizontal" method="post" action="<?php echo U('My/yizu');?>" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4"> 
                    <select name="status" >
                        <?php if($real["status"] != 0): ?><option value="0">已租</option><?php endif; ?>
                        <?php if($real["status"] != 1): ?><option value="1">待租</option><?php endif; ?>
                        <?php if($real["status"] != 2): ?><option value="2">真房</option><?php endif; ?>
                    </select>
                </div>
              </div>
                   <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >申请备注</label>  
                <div class="col-md-4">
