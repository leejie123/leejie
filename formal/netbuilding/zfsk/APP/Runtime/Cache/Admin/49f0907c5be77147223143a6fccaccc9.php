...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
  <form class="form-horizontal" method="post" action="<?php echo U('User/addvipactivity');?>">
   <fieldset>
        <input type="hidden" name="uid" value="<?php echo ($user["truename"]); ?>">
        <div class="form-group">
           <label class="col-md-4 control-label">标题</label>
           <div class="col-md-4">
              <input name="title" placeholder="标题" class="form-control input-md" type="text" >
           </div>
        </div>
        <div class="form-group">
                <label class="col-md-4 control-label" for="chanpinleibie">是否推荐</label>
                <div class="col-md-4">
                    <select id="chanpinleibie" name="is_recommend" class="form-control">
        ...
        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <select id="chanpinleibie" name="cate_id" class="form-control">
