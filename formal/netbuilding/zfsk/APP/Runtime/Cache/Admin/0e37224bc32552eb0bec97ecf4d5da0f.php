 ...
 <!-- |---------------------------------------------------------| -->
  <form class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-md-8">
          <a href="<?php echo U('Showcase/add');?>" class="btn btn-success">添加友情单位</a>
        </div>
      </div>
       <table>
          <table class="table table-striped table-responsive datatable">
                ...
                <tbody>
                <?php if(is_array($showcase)): $i = 0; $__LIST__ = $showcase;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$showcase): $mod = ($i % 2 );++$i;?><tr>
                      <td><?php echo ($key+1); ?></td>
                      <td><?php echo ($showcase["name"]); ?></td>
                      <td><a href="__PUBLIC__/upload/image/showcase/<?php echo ($showcase["image"]); ?>"><i class="fa fa-file-image-o"></i></a></td>
                      <td><?php echo ($showcase["url"]); ?></td>
                      <td><a href="<?php echo U('Showcase/update',array('id' => $showcase['id']));?>">修改</a><span>/</span>
                      <a href="<?php echo U('Showcase/delete',array('id' => $showcase['id']));?>">删除</a></td>
