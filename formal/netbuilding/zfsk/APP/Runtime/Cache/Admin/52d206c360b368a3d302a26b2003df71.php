 ...
 <!-- |---------------------------------------------------------| -->
  <form class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-md-8">
            <a href="<?php echo U('User/addvipactivity');?>" class="btn btn-success">添加活动信息</a>
          </div>
        </div>
       <table>
          <table class="table table-striped table-responsive datatable">
                ...
                <tbody>
                <?php if(is_array($vip_info_list)): $i = 0; $__LIST__ = $vip_info_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                      <td><?php echo ($vo["id"]); ?></td>
                      <td><?php echo (mb_substr($vo["title"],0,20,'utf-8')); ?></td>
                      <td><?php echo (mb_substr(strip_tags($vo["content"]),0,30,'utf-8')); ?>...</td>
                      <td><?php echo ($vo["user"]["username"]); ?></td>
                      <td><?php echo (date('Y-m-d H:i:s',$vo["create_time"])); ?></td>
                      <th><?php echo ($vo["cate"]["name"]); ?></th>
                      <td>
                      <a href="<?php echo U('User/vipactivity_detail',array('id' => $vo['id']));?>">详情</a><span>/</span><a href="<?php echo U('User/vipactivity_save',array('id' => $vo['id']));?>">修改</a><span>/</span><a href="<?php echo U('User/vipactivity_delete',array('id' => $vo['id']));?>">删除</a></td>
