 ...
 <!-- |---------------------------------------------------------| -->
  <form class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-md-8">
          <a href="<?php echo U('Property/add');?>" class="btn btn-success">添加小区</a>
        </div>
      </div>
       <table>
          <table class="table table-striped table-responsive datatable">
                ...
                <tbody>
                <?php if(is_array($property)): $i = 0; $__LIST__ = $property;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$property): $mod = ($i % 2 );++$i;?><tr>
                      <!-- <td><a href="<?php echo U('Home/Real/real_neiye',array('id' => $property['id']));?>"><?php echo ($property["id"]); ?></a></td> -->
                      <td><?php echo ($property["district_name"]); ?></td>
                      <td><?php echo ($property["area"]["name"]); ?></td>
                      <td><?php echo ($property["place_name"]); ?></td>
                      <td><?php echo ($property["developers"]); ?></td>
                      <td><?php echo ($property["property"]); ?></td>
                      <td><?php echo ($property["property_type"]); ?></td>
                      <td><?php echo ($property["property_charges"]); ?></td>
                      <td><?php echo ($property["total_area"]); ?></td>
                      <td><?php echo ($property["total_households"]); ?></td>
                      <td><?php echo (date('Y-m',$property["construction_time"])); ?></td>
                      <td><?php echo ($property["volume_ratio"]); ?></td>
                  
                      <td><?php echo ($property["parking_space"]); ?></td>
                      <td>
                        <?php if($property["recommend"] == 0): ?><a href="<?php echo U('Property/recommend',array('id' =>$property['id'],'recommend' => '1'));?>">推荐</a>
                        <?php else: ?>
                          <a href="<?php echo U('Property/recommend',array('id' =>$property['id'],'recommend' => '0'));?>">取消推荐</a><?php endif; ?>  
                      </td>
                      <td>
                      <!-- <a href="<?php echo U('Property/three_levels',array('id' => $property['id']));?>">授权</a><span>/</span> --><a href="<?php echo U('Property/upload',array('id' =>$property['id']));?>">上传图片</a><span>/</span><a href="<?php echo U('Property/update',array('id' =>$property['id']));?>">修改</a><span>/</span><a href="<?php echo U('Property/delete',array('id' =>$property['id']));?>">删除</a></td>
