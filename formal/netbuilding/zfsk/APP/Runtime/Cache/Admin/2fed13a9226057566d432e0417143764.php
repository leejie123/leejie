...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
          <form class="form-horizontal" action="<?php echo U('Staff/update');?>" method="post" enctype="multipart/form-data">
              <fieldset>
              <input value="<?php echo ($staffUpdate['id']); ?>" type="hidden" name="id">
              
              <div class="form-group" >
                 <label class="col-md-4 control-label">头像图片</label>
                 <div class="col-md-4">
                    <input type="file" class="input-file" name="top_image" value="<?php echo ($staffUpdate["top_image"]); ?>">
                 </div>
              </div>
              <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >姓名</label>  
                 <div class="col-md-4">
                <input id="truename" name="truename" value="<?php echo ($staffUpdate["truename"]); ?>" class="form-control input-md"  type="text">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="phone" name="phone" value="<?php echo ($staffUpdate["phone"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
               <!-- Text input-->
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="wechat" name="wechat" value="<?php echo ($staffUpdate["wechat"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
              <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >其他联系</label>  
                <div class="col-md-4">
                    <input id="other" name="other" value="<?php echo ($staffUpdate["other"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
                <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 control-label" >熟悉小区</label>  
                <div class="col-md-4">
                    <input id="familiar_district" name="familiar_district" value="<?php echo ($staffUpdate["familiar_district"]); ?>" class="form-control input-md"  type="text">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                  <textarea name="description" style="width: 100%; height: 200px;"><?php echo ($staffUpdate["description"]); ?></textarea>
                </div>
              </div>
...
>>>>>>> 0e62c5108d4cc05f1f457ee8fccd071c9d289b88
