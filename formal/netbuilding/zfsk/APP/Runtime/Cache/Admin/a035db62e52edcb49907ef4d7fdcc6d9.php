...
<!--           <form action="#" method="get" class="sidebar-form">
 ...
 <!-- |---------------------------------------------------------| -->
   <form class="form-horizontal" action="<?php echo U('Rbac/addNodeHandle');?>" method="post">
      <fieldset>

        <div class="form-group">
          <label class="col-md-4 control-label">英文名称</label>  
          <div class="col-md-4">
          <input id="name" name="name" placeholder="英文名称" class="form-control input-md" type="text">
          </div>
        </div>

        <div class="form-group">
          <label class="col-md-4 control-label">显示中文名称</label>  
          <div class="col-md-4">
          <input id="title" name="title" placeholder="显示中文名称" class="form-control input-md" type="text">
          </div>
        </div>
        ...
        <div class="form-group">
          <label class="col-md-4 control-label" for="node">父节点</label>
          <div class="col-md-2">
          <select id="pid" name="pid" class="form-control">
            <option value="0">根节点</option>
            <?php if(is_array($node)): $i = 0; $__LIST__ = $node;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["level"] == 1): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option><?php else: ?>
              <if condition="$vo.level eq 2"><option value="<?php echo ($vo["id"]); ?>">　| <?php echo ($vo["title"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
          </select>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input id="sort" name="sort" placeholder="排序" class="form-control input-md" required="" type="text">
          </div>
        </div>
