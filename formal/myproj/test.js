...
AdRotator = function(RotatorConfig) { (function() {
...
INice.Flash = function(settings) {
    ...
    this.play = function() {
        ...
        if (! (parseInt(flashVersion[0] + flashVersion[1] + flashVersion[2]) > 901)) {
            return '<a style="display:block;height:31px;width:165px;line-height:31px;font-size:12px;text-decoration:none;text-align:center;margin:10px auto;border:2px outset #999;" href="http://get.adobe.com/flashplayer/" target="_blank">请安装最新Flash播放�?</a>'
        }
        var f = [];
...
if (typeof(returnProvToAdPlayer) == "undefined") {
    ...
    returnColumnToAdPlayer = function() {
        ...
        if (path.length > 1) {
            ...
            try {
                if (location.href.indexOf("_v_ad01") > 0) {
                    ret = "_v_ad01"
                } else {
                    if (location.href.indexOf("_v_ad02") > 0) {
                        ret = "_v_ad02"
                    } else {
                        if (location.href.indexOf("_v_ad03") > 0) {
                            ret = "_v_ad03"
                        } else {
                            if (location.href.indexOf("v.ifeng.com/qudao/special/kuaibao/") > 0) {
                                ret = "_v_btgg"
                            } else {
...
if (iNiceBrowser.CHROME) {
    document.write('<div style="position:absolute;top:0px;overflow:hidden;">');
    document.write('<embed id="inice_swf" width="400px" height="300px" style="display:none;" wmode="transparent" src="http://c1.ifengimg.com/mappa/2016/08/18/39149784afc6ff385637057422f75c97.swf" allowscriptaccess="always" flashvars="" type="application/x-shockwave-flash"></embed>');
    document.write("</div>");
    document.write("<scr" + 'ipt language="javascript">');
    document.write("function set_inice_swf() {");
    document.write('document.getElementById("inice_swf").style.display = "inline";');
    document.write('setTimeout("set_inice_swf_n();", 50);');
    document.write("}");
    document.write("function set_inice_swf_n() {");
    document.write('document.getElementById("inice_swf").style.display = "none";');
    document.write("}");
    document.write('setTimeout("set_inice_swf();", 50);');
